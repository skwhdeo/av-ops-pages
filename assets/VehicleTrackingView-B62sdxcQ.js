...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Yn,depthTest:!1,depthWrite:!1})}function Vo(){return new Kn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Za(),fragmentShader:`
		...
		`,blending:Yn,depthTest:!1,depthWrite:!1})}function Ho(){return new Kn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Za(),fragmentShader:`
