...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function Ao(){return new Vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Oa(),fragmentShader:`
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function wo(){return new Vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Oa(),fragmentShader:`
...
`)}function Mp(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function qi(i){return i!==""}function Bo(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Vo(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Sp=/^[ \t]*#include +<([\w\d./]+)>/gm;function ya(i){return i.replace(Sp,Ep)}const yp=new Map;function Ep(i,e){let t=qe[e];if(t===void 0){const n=yp.get(e);if(n!==void 0)t=qe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ya(t)}const Tp=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function zo(i){return i.replace(Tp,bp)}function bp(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function ko(i){let e=`precision ${i.precision} float;
...
`].filter(qi).join(`
`),f=[ko(t),"#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,M,t.useFog&&t.fog?"#define USE_FOG":"",t.useFog&&t.fogExp2?"#define FOG_EXP2":"",t.alphaToCoverage?"#define ALPHA_TO_COVERAGE":"",t.map?"#define USE_MAP":"",t.matcap?"#define USE_MATCAP":"",t.envMap?"#define USE_ENVMAP":"",t.envMap?"#define "+l:"",t.envMap?"#define "+d:"",t.envMap?"#define "+h:"",p?"#define CUBEUV_TEXEL_WIDTH "+p.texelWidth:"",p?"#define CUBEUV_TEXEL_HEIGHT "+p.texelHeight:"",p?"#define CUBEUV_MAX_MIP "+p.maxMip+".0":"",t.lightMap?"#define USE_LIGHTMAP":"",t.aoMap?"#define USE_AOMAP":"",t.bumpMap?"#define USE_BUMPMAP":"",t.normalMap?"#define USE_NORMALMAP":"",t.normalMapObjectSpace?"#define USE_NORMALMAP_OBJECTSPACE":"",t.normalMapTangentSpace?"#define USE_NORMALMAP_TANGENTSPACE":"",t.emissiveMap?"#define USE_EMISSIVEMAP":"",t.anisotropy?"#define USE_ANISOTROPY":"",t.anisotropyMap?"#define USE_ANISOTROPYMAP":"",t.clearcoat?"#define USE_CLEARCOAT":"",t.clearcoatMap?"#define USE_CLEARCOATMAP":"",t.clearcoatRoughnessMap?"#define USE_CLEARCOAT_ROUGHNESSMAP":"",t.clearcoatNormalMap?"#define USE_CLEARCOAT_NORMALMAP":"",t.dispersion?"#define USE_DISPERSION":"",t.iridescence?"#define USE_IRIDESCENCE":"",t.iridescenceMap?"#define USE_IRIDESCENCEMAP":"",t.iridescenceThicknessMap?"#define USE_IRIDESCENCE_THICKNESSMAP":"",t.specularMap?"#define USE_SPECULARMAP":"",t.specularColorMap?"#define USE_SPECULAR_COLORMAP":"",t.specularIntensityMap?"#define USE_SPECULAR_INTENSITYMAP":"",t.roughnessMap?"#define USE_ROUGHNESSMAP":"",t.metalnessMap?"#define USE_METALNESSMAP":"",t.alphaMap?"#define USE_ALPHAMAP":"",t.alphaTest?"#define USE_ALPHATEST":"",t.alphaHash?"#define USE_ALPHAHASH":"",t.sheen?"#define USE_SHEEN":"",t.sheenColorMap?"#define USE_SHEEN_COLORMAP":"",t.sheenRoughnessMap?"#define USE_SHEEN_ROUGHNESSMAP":"",t.transmission?"#define USE_TRANSMISSION":"",t.transmissionMap?"#define USE_TRANSMISSIONMAP":"",t.thicknessMap?"#define USE_THICKNESSMAP":"",t.vertexTangents&&t.flatShading===!1?"#define USE_TANGENT":"",t.vertexColors||t.instancingColor||t.batchingColor?"#define USE_COLOR":"",t.vertexAlphas?"#define USE_COLOR_ALPHA":"",t.vertexUv1s?"#define USE_UV1":"",t.vertexUv2s?"#define USE_UV2":"",t.vertexUv3s?"#define USE_UV3":"",t.pointsUvs?"#define USE_POINTS_UV":"",t.gradientMap?"#define USE_GRADIENTMAP":"",t.flatShading?"#define FLAT_SHADED":"",t.doubleSided?"#define DOUBLE_SIDED":"",t.flipSided?"#define FLIP_SIDED":"",t.shadowMapEnabled?"#define USE_SHADOWMAP":"",t.shadowMapEnabled?"#define "+c:"",t.premultipliedAlpha?"#define PREMULTIPLIED_ALPHA":"",t.numLightProbes>0?"#define USE_LIGHT_PROBES":"",t.decodeVideoTexture?"#define DECODE_VIDEO_TEXTURE":"",t.decodeVideoTextureEmissive?"#define DECODE_VIDEO_TEXTURE_EMISSIVE":"",t.logarithmicDepthBuffer?"#define USE_LOGDEPTHBUF":"",t.reversedDepthBuffer?"#define USE_REVERSEDEPTHBUF":"","uniform mat4 viewMatrix;","uniform vec3 cameraPosition;","uniform bool isOrthographic;",t.toneMapping!==Fn?"#define TONE_MAPPING":"",t.toneMapping!==Fn?qe.tonemapping_pars_fragment:"",t.toneMapping!==Fn?gp("toneMapping",t.toneMapping):"",t.dithering?"#define DITHERING":"",t.opaque?"#define OPAQUE":"",qe.colorspace_pars_fragment,mp("linearToOutputTexel",t.outputColorSpace),_p(),t.useDepthPacking?"#define DEPTH_PACKING "+t.depthPacking:"",`
`].filter(qi).join(`
`)),a=ya(a),a=Bo(a,t),a=Vo(a,t),o=ya(o),o=Bo(o,t),o=Vo(o,t),a=zo(a),o=zo(o),t.isRawShaderMaterial!==!0&&(D=`#version 300 es
`,_=[m,"#define attribute in","#define varying out","#define texture2D texture"].join(`
`)+`
`+_,f=["#define varying in",t.glslVersion===Xa?"":"layout(location = 0) out highp vec4 pc_fragColor;",t.glslVersion===Xa?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+f);const R=D+_+a,b=D+f+o,O=No(s,s.VERTEX_SHADER,R),C=No(s,s.FRAGMENT_SHADER,b);s.attachShader(S,O),s.attachShader(S,C),t.index0AttributeName!==void 0?s.bindAttribLocation(S,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(S,0,"position"),s.linkProgram(S);function U(L){if(i.debug.checkShaderErrors){const J=s.getProgramInfoLog(S)||"",q=s.getShaderInfoLog(O)||"",j=s.getShaderInfoLog(C)||"",ie=J.trim(),Y=q.trim(),oe=j.trim();let $=!0,Q=!0;if(s.getProgramParameter(S,s.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,S,O,C);else{const te=Fo(s,O,"vertex"),ve=Fo(s,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(S,s.VALIDATE_STATUS)+`
...
`);let s=[];for(let o=0,c=n.length;o<c;o++){const l=n[o].trimStart();if(l.length===0)continue;const d=l.charAt(0);if(d!=="#")if(d==="v"){const h=l.split(Xo);switch(h[0]){case"v":t.vertices.push(parseFloat(h[1]),parseFloat(h[2]),parseFloat(h[3])),h.length>=7?(Is.setRGB(parseFloat(h[4]),parseFloat(h[5]),parseFloat(h[6]),$t),t.colors.push(Is.r,Is.g,Is.b)):t.colors.push(void 0,void 0,void 0);break;case"vn":t.normals.push(parseFloat(h[1]),parseFloat(h[2]),parseFloat(h[3]));break;case"vt":t.uvs.push(parseFloat(h[1]),parseFloat(h[2]));break}}else if(d==="f"){const p=l.slice(1).trim().split(Xo),m=[];for(let S=0,_=p.length;S<_;S++){const f=p[S];if(f.length>0){const D=f.split("/");m.push(D)}}const M=m[0];for(let S=1,_=m.length-1;S<_;S++){const f=m[S],D=m[S+1];t.addFace(M[0],f[0],D[0],M[1],f[1],D[1],M[2],f[2],D[2])}}else if(d==="l"){const h=l.substring(1).trim().split(" ");let p=[];const m=[];if(l.indexOf("/")===-1)p=h;else for(let M=0,S=h.length;M<S;M++){const _=h[M].split("/");_[0]!==""&&p.push(_[0]),_[1]!==""&&m.push(_[1])}t.addLineGeometry(p,m)}else if(d==="p"){const p=l.slice(1).trim().split(" ");t.addPointGeometry(p)}else if((s=am.exec(l))!==null){const h=(" "+s[0].slice(1).trim()).slice(1);t.startObject(h)}else if(lm.test(l))t.object.startMaterial(l.substring(7).trim(),t.materialLibraries);else if(om.test(l))t.materialLibraries.push(l.substring(7).trim());else if(cm.test(l))console.warn('THREE.OBJLoader: Rendering identifier "usemap" not supported. Textures must be defined in MTL files.');else if(d==="s"){if(s=l.split(" "),s.length>1){const p=s[1].trim().toLowerCase();t.object.smooth=p!=="0"&&p!=="off"}else t.object.smooth=!0;const h=t.object.currentMaterial();h&&(h.smooth=t.object.smooth)}else{if(l==="\0")continue;console.warn('THREE.OBJLoader: Unexpected line: "'+l+'"')}}t.finalize();const r=new ei;if(r.materialLibraries=[].concat(t.materialLibraries),!(t.objects.length===1&&t.objects[0].geometry.vertices.length===0)===!0)for(let o=0,c=t.objects.length;o<c;o++){const l=t.objects[o],d=l.geometry,h=l.materials,p=d.type==="Line",m=d.type==="Points";let M=!1;if(d.vertices.length===0)continue;const S=new en;S.setAttribute("position",new Ft(d.vertices,3)),d.normals.length>0&&S.setAttribute("normal",new Ft(d.normals,3)),d.colors.length>0&&(M=!0,S.setAttribute("color",new Ft(d.colors,3))),d.hasUVIndices===!0&&S.setAttribute("uv",new Ft(d.uvs,2));const _=[];for(let D=0,R=h.length;D<R;D++){const b=h[D],O=b.name+"_"+b.smooth+"_"+M;let C=t.materials[O];if(this.materials!==null){if(C=this.materials.create(b.name),p&&C&&!(C instanceof ji)){const U=new ji;gn.prototype.copy.call(U,C),U.color.copy(C.color),C=U}else if(m&&C&&!(C instanceof $i)){const U=new $i({size:10,sizeAttenuation:!1});gn.prototype.copy.call(U,C),U.color.copy(C.color),U.map=C.map,C=U}}C===void 0&&(p?C=new ji:m?C=new $i({size:1,sizeAttenuation:!1}):C=new dd,C.name=b.name,C.flatShading=!b.smooth,C.vertexColors=M,t.materials[O]=C),_.push(C)}let f;if(_.length>1){for(let D=0,R=h.length;D<R;D++){const b=h[D];S.addGroup(b.groupStart,b.groupCount,D)}p?f=new po(S,_):m?f=new br(S,_):f=new Qt(S,_)}else p?f=new po(S,_[0]):m?f=new br(S,_[0]):f=new Qt(S,_[0]);f.name=l.name,r.add(f)}else if(t.vertices.length>0){const o=new $i({size:1,sizeAttenuation:!1}),c=new en;c.setAttribute("position",new Ft(t.vertices,3)),t.colors.length>0&&t.colors[0]!==void 0&&(c.setAttribute("color",new Ft(t.colors,3)),o.vertexColors=!0);const l=new br(c,o);r.add(l)}return r}}const hm={key:0,class:"hud"},fm=["max"],pm=Ko({__name:"Pip3D",props:{width:{default:560},height:{default:350},dataUrl:{default:"/pip_test_data.json"},wsUrl:{default:""},modelPaths:{default:()=>({bus:"/bus.obj",car:"/car.obj",pedestrian:"/pedestrian.obj"})},cameraMode:{default:"chase"}},setup(i){const e=i,t=Pl([]),n=ze(0),s=ze(0),r=ze(!0);let a=null;const o=[],c=Mi(()=>t.length?e.wsUrl?t[t.length-1]:t[n.value]:null),l=ze(null),d=ze(null);let h,p,m,M=0,S,_,f;const D=new um,R=new Ar({color:16777215,metalness:0,roughness:1}),b=new Ar({color:14278115,metalness:0,roughness:.9}),O=new Ar({color:11388671,roughness:.85}),C={};async function U(Q){if(C[Q])return C[Q].clone(!0);const te=await D.loadAsync(Q);return te.traverse(ve=>{ve.isMesh&&(ve.castShadow=!0,ve.receiveShadow=!0)}),C[Q]=te,te.clone(!0)}const B={};function A(Q){return`${Q.type}-${Q.id}`}const T={};function L(Q,te){if(Q==="top")m.position.set(te.x,30,te.z),m.lookAt(te.x,0,te.z);else{const ve=new G(te.x,3.5,te.z-10);m.position.lerp(ve,.12),m.lookAt(te.x,.8,te.z+6)}}async function J(){p=new ad,p.background=new je(16185337),m=new Jt(45,e.width/e.height,.1,1e3),m.position.set(0,6,12),h=new rm({canvas:d.value,antialias:!0}),h.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),h.setSize(e.width,e.height),h.shadowMap.enabled=!0,p.add(new Md(16777215,.6)),f=new xd(16777215,.6),f.position.set(10,12,6),f.castShadow=!0,p.add(f);const Q=new rs(200,200);_=new Qt(Q,R),_.receiveShadow=!0,_.rotation.x=-Math.PI/2,p.add(_),S=new ei;const te=await U(e.modelPaths.bus);te.traverse(ve=>{ve.isMesh&&(ve.material=O)}),S.add(te),p.add(S),q()}function q(){M=requestAnimationFrame(q);const Q=c.value;if(Q){const{x:te=0,y:ve=0,z:ke=0,yaw:rt=0}=Q.ego||{};S.position.set(te,ve,ke),S.rotation.set(0,rt,0),L(e.cameraMode,{x:te,z:ke});const Je={};for(const X of Q.objects||[]){const ce=A(X);let ne=B[ce];if(!ne){ne=new ei,B[ce]=ne,p.add(ne);let ue=e.modelPaths.car;X.type==="pedestrian"&&(ue=e.modelPaths.pedestrian),U(ue).then(Ee=>{Ee.traverse(Ne=>{Ne.isMesh&&(Ne.material=b)}),ne.add(Ee)})}ne.position.set(X.x??0,X.y??0,X.z??0),ne.rotation.set(0,X.yaw??0,0),Je[ce]=!0}for(const[X,ce]of Object.entries(B))Je[X]||(p.remove(ce),delete B[X]);for(const X of Q.lanes||[]){let ce=T[X.id];const ne=(X.pts||[]).map(ue=>new G(ue[0],ue[1],ue[2]));if(ce)ce.geometry.setFromPoints(ne),ce.geometry.computeBoundingSphere();else{const ue=new en().setFromPoints(ne),Ee=new ji({color:13686237});ce=new Ml(ue,Ee),T[X.id]=ce,p.add(ce)}}}h.render(p,m)}async function j(){const te=await(await fetch(e.dataUrl)).json();t.splice(0,t.length,...te.frames||[])}function ie(){e.wsUrl&&(a=new WebSocket(e.wsUrl),a.onmessage=Q=>{try{const te=JSON.parse(Q.data);o.push(te),o.length>240&&o.shift(),t.splice(0,t.length,...o)}catch(te){console.warn("WS parse error",te)}},a.onclose=()=>{})}let Y=0;function oe(){$();const Q=()=>{var te;t.length&&r.value&&(n.value=(n.value+1)%t.length,s.value=((te=t[n.value])==null?void 0:te.ts_ms)||0),Y=requestAnimationFrame(Q)};Y=requestAnimationFrame(Q)}function $(){Y&&cancelAnimationFrame(Y)}return Dl(()=>[e.width,e.height],([Q,te])=>{h&&m&&(h.setSize(Q,te),m.aspect=Q/te,m.updateProjectionMatrix())}),Zo(async()=>{await J(),e.wsUrl?ie():(await j(),oe())}),Ll(()=>{cancelAnimationFrame(M),$(),a==null||a.close(),h==null||h.dispose();for(const Q of Object.values(B))p.remove(Q)}),(Q,te)=>(Ue(),Ie("div",{ref_key:"wrap",ref:l,class:"pip3d",style:Il({width:`${Q.width}px`,height:`${Q.height}px`})},[E("canvas",{ref_key:"canvas",ref:d},null,512),Q.wsUrl?Ke("",!0):(Ue(),Ie("div",hm,[E("button",{onClick:te[0]||(te[0]=ve=>r.value=!r.value)},Me(r.value?"Pause":"Play"),1),E("span",null,"t: "+Me(s.value),1),Xi(E("input",{type:"range",min:0,max:Math.max(0,t.length-1),"onUpdate:modelValue":te[1]||(te[1]=ve=>n.value=ve)},null,8,fm),[[Ul,n.value,void 0,{number:!0}]])]))],4))}}),Yo=Jo(pm,[["__scopeId","data-v-8d334c00"]]),mm={class:"vehicle-tracking-container"},gm={class:"header px-6 py-4 bg-white shadow-sm"},_m={class:"flex items-center gap-4 mt-4"},vm={class:"flex items-center gap-2"},xm={class:"text-sm text-gray-700"},Mm={class:"flex items-center gap-2"},Sm={class:"text-sm text-gray-700"},ym={class:"flex items-center gap-2"},Em={class:"text-sm text-gray-700"},Tm={class:"flex items-center gap-2"},bm={class:"text-sm text-gray-700"},Am={class:"text-sm text-gray-500 flex items-center gap-2"},wm={class:"flex items-center gap-2 ml-auto"},Rm={key:0,class:"text-xs text-orange-600 bg-orange-50 px-2 py-1 rounded border border-orange-200"},Cm=["disabled"],Pm={class:"main-content"},Dm={class:"map-container"},Lm={class:"pip-header"},Im={class:"pip-controls"},Um={key:0,width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor"},Nm={key:1,width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor"},Om={class:"pip-header"},Fm={class:"pip-controls"},Bm={key:0,width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor"},Vm={key:1,width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor"},zm={class:"pip-header"},km={class:"pip-controls"},Hm={key:0,width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor"},Gm={key:1,width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor"},Wm={class:"panel-content"},Xm={class:"info-section"},$m={class:"info-grid"},qm={class:"info-item"},jm={class:"info-value"},Ym={class:"info-item"},Km={class:"info-value"},Zm={class:"info-item"},Jm={class:"info-item"},Qm={class:"info-section"},eg={class:"info-grid"},tg={class:"info-item"},ng={class:"info-value"},ig={class:"info-item"},sg={class:"info-value"},rg={key:0,class:"info-item"},ag={class:"info-value"},og={key:1,class:"info-item"},lg={class:"info-value"},cg={class:"info-section"},dg={class:"info-grid"},ug={class:"info-item full-width"},hg={class:"info-value font-mono text-xs"},fg={class:"info-item"},pg={class:"info-value"},mg={class:"info-item"},gg={class:"info-value"},_g={key:0,class:"info-item"},vg={class:"info-value"},xg={key:1,class:"info-item"},Mg={class:"info-value"},Sg={class:"info-section"},yg={class:"object-detection-grid"},Eg={class:"detection-item"},Tg={class:"detection-info"},bg={class:"detection-count"},Ag={class:"detection-item"},wg={class:"detection-info"},Rg={class:"detection-count"},Cg={class:"detection-item"},Pg={class:"detection-info"},Dg={class:"detection-count"},Lg={class:"detection-item"},Ig={class:"detection-info"},Ug={class:"info-section"},Ng={class:"odd-status-header"},Og={class:"odd-status-icon"},Fg={class:"odd-status-content"},Bg={class:"odd-status-value"},Vg={key:0,class:"odd-distance"},zg={class:"environment-conditions"},kg={class:"condition-grid"},Hg={class:"condition-item"},Gg={class:"condition-info"},Wg={class:"condition-value"},Xg={class:"condition-item"},$g={class:"condition-info"},qg={class:"condition-value"},jg={class:"condition-item"},Yg={class:"condition-info"},Kg={class:"condition-value"},Zg={class:"condition-item"},Jg={class:"condition-info"},Qg={class:"condition-value"},e_={class:"system-limits"},t_={class:"limit-status-list"},n_={key:0,class:"intervention-alert"},i_={class:"intervention-content"},s_={class:"intervention-reason"},r_={class:"safety-text"},a_={key:0,class:"odd-warning-card"},o_={class:"warning-content"},l_={class:"warning-distance"},c_={class:"distance-value"},d_={class:"warning-eta"},u_={class:"eta-value"},h_={class:"warning-action"},f_={class:"action-text"},p_={key:1,class:"absolute inset-0 bg-white bg-opacity-75 flex items-center justify-center z-10"},m_={key:2,class:"absolute top-4 right-4 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded z-10"},g_={class:"text-sm"},__={class:"sidebar"},v_={class:"sidebar-content"},x_={key:0,class:"text-center text-gray-500 py-8"},M_={key:1,class:"space-y-3"},S_=["onClick"],y_={class:"flex items-center justify-between mb-2"},E_={class:"flex items-center gap-2"},T_={class:"font-medium text-gray-800"},b_={class:"text-xs px-2 py-1 bg-gray-100 text-gray-700 rounded-full"},A_={class:"text-sm text-gray-600 space-y-1"},w_={class:"flex justify-between"},R_={class:"text-purple-600"},C_={key:0,class:"flex justify-between"},P_={class:"font-medium"},D_={class:"text-blue-600"},L_={key:1,class:"mt-2 p-2 bg-green-50 border border-green-200 rounded text-xs"},I_={class:"space-y-1 text-green-700"},U_={class:"flex justify-between"},N_={class:"font-mono"},O_={class:"flex justify-between"},F_={class:"font-mono"},B_={key:0,class:"mt-1 pt-1 border-t border-green-300"},V_={key:0,class:"flex justify-between"},z_={class:"font-medium"},k_={key:1,class:"mt-1"},H_={class:"flex flex-wrap gap-1 mt-1"},G_={key:2,class:"flex justify-between"},W_={class:"font-mono"},X_={class:"flex justify-between"},$_={key:0,class:"text-xs"},q_={key:2,class:"mt-1 p-2 bg-orange-50 rounded text-xs"},j_={class:"flex justify-between"},Y_={class:"mt-3 pt-2 border-t border-gray-200"},K_={class:"flex gap-2"},Z_=["onClick","disabled"],J_=["onClick","disabled"],Q_={key:3,class:"mt-2 pt-2 border-t border-gray-200"},ev={key:0,class:"bg-blue-50 p-2 rounded text-xs mb-2"},tv={class:"flex justify-between mb-1"},nv={class:"font-medium text-blue-900"},iv={class:"flex justify-between"},sv={class:"font-medium text-blue-900"},rv={key:1,class:"flex justify-between text-xs"},av={class:"text-green-600 font-medium"},ov={key:2,class:"flex justify-between text-xs"},lv={class:"text-indigo-600"},cv={key:3,class:"flex justify-between text-xs"},dv={class:"text-gray-700"},uv={key:4,class:"mt-2 pt-2 border-t border-gray-200"},hv={key:0,class:"space-y-2"},fv={class:"flex justify-between text-xs"},pv={class:"text-purple-600 font-medium"},mv={class:"font-medium text-green-800 mb-1"},gv={class:"space-y-1 text-green-700"},_v={class:"flex items-start gap-1"},vv={class:"flex-1"},xv=["title"],Mv={class:"flex items-start gap-1"},Sv={class:"flex-1"},yv=["title"],Ev={key:0,class:"text-xs text-gray-600"},Tv={key:0,class:"text-xs text-gray-500 text-center"},bv={key:1,class:"flex justify-between text-xs mt-2"},Av={class:"text-gray-700"},wv={key:2,class:"flex justify-between text-xs"},Rv={class:"text-gray-700"},Cv={class:"mt-2 pt-2 border-t border-gray-200"},Pv={class:"flex justify-between text-xs"},Dv={class:"font-mono"},Lv={key:0,class:"flex justify-between text-xs"},Iv={class:"text-gray-700"},Uv={key:1,class:"flex justify-between text-xs"},Nv={class:"text-gray-700"},Ov=Ko({__name:"VehicleTrackingView",setup(i){delete pt.Icon.Default.prototype._getIconUrl,pt.Icon.Default.mergeOptions({iconRetinaUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/images/marker-icon-2x.png",iconUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/images/marker-icon.png",shadowUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/images/marker-shadow.png"});const e=new Vl({basePath:"https://av-ops.maas-busan.shop",baseOptions:{timeout:1e4,headers:{"Content-Type":"application/json",Accept:"application/json"}}}),t=new Hl(e);new Xl(e);const n=new kl(e),s=new Gl(e),r=new zl(e),a="https://av-ops.maas-busan.shop",o=ze(),c=ze(),l=ze(new Map),d=ze(new Map),h=ze(new Map),p=ze(new Map),m=ze(new Map),M=ze(new Map),S=ze(new Map),_=ze([]),f=ze(new Map),D=ze(new Map),R=ze(new Map),b=ze(!1),O=ze(!1),C=ze(null),U=ze([]),B=ze([]),A=ze([]),T=ze([]),L=ze(""),J=ze(1e3),q=ze(),j=ze(),ie=ze(),Y=ze(),oe=ze(),$=ze(),Q=ze(!1),te=ze(!1),ve=ze(!1),ke=ze(!0),rt=ze(!0),Je=ze(!0),X=ze(null),ce=ze({x:0,y:0}),ne=ze(null),ue=ze(null),Ee=ze({pedestrians:0,vehicles:0,bicycles:0}),Ne=ze("녹색"),dt=Mi(()=>{const g=Ne.value;return g==="녹색"?"text-green-600":g==="황색"?"text-yellow-600":g==="적색"?"text-red-600":"text-gray-600"}),Ce=ze({inODD:!0,distanceToBoundary:850,approachingBoundary:!1,etaToBoundary:60,recommendedAction:"정상 운행 가능",weather:"맑음",lighting:"주간",roadCondition:"건조",temperature:23,systemLimits:{oddExceeded:!1,sensorFailure:!1,weatherLimit:!1,gpsLoss:!1},driverInterventionRequired:!1,interventionReason:"",safetyStopAvailable:!0});let P=null;const st=[35.1796,129.0756],Ae=Mi(()=>{console.log("=== 운행 중 차량 필터링 ==="),console.log("전체 차량 수:",U.value.length),console.log("수요응답 Trip 수:",B.value.length),console.log("정기노선 Trip 수:",A.value.length),B.value.length>0&&console.log("수요응답 Trip 상태들:",B.value.map(u=>({id:u.id,vehicle_id:u.vehicle_id,status:u.status}))),A.value.length>0&&console.log("정기노선 Trip 상태들:",A.value.map(u=>({id:u.id,vehicle_id:u.vehicle_id,status:u.status})));const g=U.value.filter(u=>{var z,V;const v=B.value.find(W=>W.vehicle_id===u.id);if(v&&(console.log(`🚗 차량 ${u.id}: 수요응답 Trip #${v.id} (상태: ${v.status})`,{calls_count:((z=v.calls)==null?void 0:z.length)||0,call_ids:((V=v.calls)==null?void 0:V.map(W=>W.id))||[],service_area_id:v.service_area_id}),v.status!=="SCHEDULED"&&v.status!=="COMPLETED"))return!0;const I=A.value.find(W=>W.vehicle_id===u.id);return!!(I&&(console.log(`차량 ${u.id}: 정기노선 Trip 상태 = ${I.status}`),I.status!=="SCHEDULED"&&I.status!=="COMPLETED"))});return console.log("필터링 결과: 운행 중 차량 수 =",g.length),console.log("=== 필터링 종료 ==="),g.map(u=>{const v=B.value.find(V=>V.vehicle_id===u.id),I=A.value.find(V=>V.vehicle_id===u.id),z=v||I;return{...u,trip_id:z==null?void 0:z.id,tripStatus:z==null?void 0:z.status,tripType:v?"ON_DEMAND":"SCHEDULED"}})}),Qe=Mi(()=>Ae.value.filter(g=>g.tripType==="SCHEDULED"&&g.tripStatus!=="RETURNING").length),De=Mi(()=>Ae.value.filter(g=>g.tripType==="ON_DEMAND"&&g.tripStatus!=="RETURNING").length),lt=Mi(()=>Ae.value.filter(g=>g.tripStatus==="RETURNING").length),ye=()=>{try{if(console.log("지도 초기화 시작..."),console.log("mapContainer.value:",o.value),!o.value){console.error("지도 컨테이너를 찾을 수 없습니다");return}c.value&&c.value.remove(),console.log("Leaflet 지도 객체 생성 중..."),c.value=pt.map(o.value,{center:st,zoom:13,zoomControl:!0,attributionControl:!0,minZoom:10,maxZoom:18}),console.log("타일 레이어 추가 중...");const g=pt.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"© OpenStreetMap contributors",maxZoom:19,subdomains:["a","b","c"]});g.addTo(c.value),g.on("loading",()=>{console.log("타일 로딩 시작")}),g.on("load",()=>{console.log("타일 로딩 완료")}),console.log("지도 초기화 완료"),console.log("지도 객체:",c.value)}catch(g){console.error("지도 초기화 실패:",g),g.value=`지도 초기화 실패: ${g.message}`}},We=async()=>{try{console.log("서비스 지역 조회 중...");const g=await s.getServiceAreasApiServiceAreasGet();T.value=g.data||[],console.log(`서비스 지역 ${T.value.length}개 조회 완료`),console.log("서비스 지역 데이터:",T.value),T.value.length>0&&c.value&&(ut(),_t())}catch(g){console.error("서비스 지역 조회 실패:",g)}},_t=()=>{if(!(!c.value||T.value.length===0))try{console.log("서비스 지역 기준으로 지도 범위 조정 중...");let g=null,u=0;T.value.forEach(v=>{v.geojson&&v.geojson.features&&v.geojson.features.forEach(I=>{if(I.geometry&&I.geometry.coordinates){const z=(V,W=0)=>{if(!(W>3)&&Array.isArray(V))if(V.length===2&&typeof V[0]=="number"&&typeof V[1]=="number"){const fe=pt.latLng(V[1],V[0]);g?g.extend(fe):g=pt.latLngBounds([fe]),u++}else V.forEach(fe=>z(fe,W+1))};z(I.geometry.coordinates)}})}),g&&u>0?(console.log(`${u}개 좌표로 지도 범위 설정`),console.log("범위:",g.getSouthWest(),"~",g.getNorthEast()),c.value.fitBounds(g,{padding:[20,20],maxZoom:15})):(console.warn("서비스 지역 좌표를 찾을 수 없어 기본 위치 사용"),c.value.setView(st,11))}catch(g){console.error("지도 범위 조정 실패:",g),c.value.setView(st,11)}},ut=()=>{c.value&&(_.value.forEach(g=>{var u;(u=c.value)==null||u.removeLayer(g)}),_.value=[],T.value.forEach(g=>{if(g.geojson)try{const u=pt.geoJSON(g.geojson,{style:{color:"#3b82f6",weight:2,opacity:.8,fillColor:"#3b82f6",fillOpacity:.1},onEachFeature:(v,I)=>{const z=`
  ...
  `},de=(g,u)=>{try{f.value||(f.value=new Map);const v=f.value.get(g.id),I=u.current_latitude,z=u.current_longitude;if(!v||!I||!z)return f.value.set(g.id,{lat:I,lng:z,timestamp:Date.now()}),null;if(_e(v.lat,v.lng,I,z)<9e-5)return null;const W=Oe(v.lat,v.lng,I,z);return f.value.set(g.id,{lat:I,lng:z,timestamp:Date.now()}),Math.round(W)}catch(v){return console.error("heading 계산 오류:",v),null}},_e=(g,u,v,I)=>{const z=v-g,V=I-u;return Math.sqrt(z*z+V*V)},Oe=(g,u,v,I)=>{const z=(I-u)*Math.PI/180,V=g*Math.PI/180,W=v*Math.PI/180,fe=Math.sin(z)*Math.cos(W),k=Math.cos(V)*Math.sin(W)-Math.sin(V)*Math.cos(W)*Math.cos(z);return(Math.atan2(fe,k)*180/Math.PI+360)%360},Re=(g,u,v)=>{if(!c.value||!u.start_node||!u.end_node)return;const I=S.value.get(g);I&&c.value.removeLayer(I);const z=u.start_node.latitude+(u.end_node.latitude-u.start_node.latitude)*v,V=u.start_node.longitude+(u.end_node.longitude-u.start_node.longitude)*v,W=pt.divIcon({className:"progress-arrow",html:'<div style="color: #FF0000; font-size: 20px; font-weight: bold; text-shadow: 0 0 3px white;">→</div>',iconSize:[20,20],iconAnchor:[10,10]}),fe=pt.marker([z,V],{icon:W});fe.addTo(c.value),S.value.set(g,fe)},me=async(g,u)=>{var I,z,V,W,fe;const v=`${g}-${u}`;if(h.value.has(v)){const k=h.value.get(v);return console.log(`🔗 링크 캐시 히트 ${v}:`,{has_geojson:!!(k.geojson&&k.geojson.geometry),geojson_type:(z=(I=k.geojson)==null?void 0:I.geometry)==null?void 0:z.type,coordinates_count:(fe=(W=(V=k.geojson)==null?void 0:V.geometry)==null?void 0:W.coordinates)==null?void 0:fe.length}),k}try{if(console.log(`🔗 링크 캐시 사이즈: ${h.value.size}`),h.value.size===0){console.log("🌐 Network API에서 모든 링크 정보 로드 중...");const ae=await r.getActiveLinksApiNetworkLinksGet();ae.data?(console.log(`🌐 Network API 응답: ${ae.data.length}개 링크`),ae.data.forEach(xe=>{const Fe=`${xe.from_node_id}-${xe.to_node_id}`;h.value.set(Fe,xe)}),console.log(`🔗 링크 캐시 구축 완료: ${h.value.size}개 링크`)):console.warn("🌐 Network API 응답 데이터 없음")}const k=h.value.get(v)||null;return k||console.warn(`🔗 링크 ${v} 캐시에서 찾을 수 없음`),k}catch(k){return console.error("🌐 링크 정보 조회 실패:",k),null}},Ge=g=>{var u;!c.value||!g.stops||(p.value.forEach(v=>{var I;(I=c.value)==null||I.removeLayer(v)}),p.value.clear(),(u=g.stops)==null||u.forEach(v=>{const I=pt.divIcon({className:"stop-marker",html:`
    ...
    `,className:"vehicle-icon",iconSize:[40,40],iconAnchor:[20,20]})},pe=async()=>{if(!c.value)return;const g=new Set(Ae.value.map(v=>v.id)),u=new Set(l.value.keys());for(const v of u)if(!g.has(v)){const I=l.value.get(v);I&&(c.value.removeLayer(I),l.value.delete(v));const z=d.value.get(v);z&&(z.forEach(W=>{var fe;return(fe=c.value)==null?void 0:fe.removeLayer(W)}),d.value.delete(v));const V=m.value.get(v);V&&(c.value.removeLayer(V),m.value.delete(v))}Ae.value.forEach(v=>{if(v.current_latitude&&v.current_longitude){const I=l.value.get(v.id);if(!I)be(v),Z(v);else{const z=pt.latLng(v.current_latitude,v.current_longitude);I.setLatLng(z);const V=we(v);I.setPopupContent(V),Z(v)}}}),console.log(`${Ae.value.length}대의 차량 차등 업데이트 완료`)},Se=async()=>{b.value=!0,C.value=null;try{await ee(),console.log("수동 새로고침 완료")}catch(g){console.error("수동 새로고침 실패:",g),C.value=g.message||"데이터 로드 중 오류가 발생했습니다."}finally{b.value=!1}},re=async()=>{O.value=!0;try{await ee(),J.value>1e3&&console.log("백그라운드 업데이트 완료")}catch(g){console.error("백그라운드 업데이트 실패:",g)}finally{O.value=!1}},ee=async()=>{await w(),await Promise.all([x(),H(),We()]),await pe(),L.value=new Date().toLocaleString("ko-KR")},Te=(g,u)=>{qt(g);const v=u%3;ne.value===v?(ne.value=null,ue.value=null,Ee.value={pedestrians:0,vehicles:0,bicycles:0}):(ne.value=v,ue.value=g,at(),et(),tn())},He=()=>{ne.value=null,ue.value=null,Ee.value={pedestrians:0,vehicles:0,bicycles:0}},at=()=>{Ee.value={pedestrians:Math.floor(Math.random()*5),vehicles:Math.floor(Math.random()*8),bicycles:Math.floor(Math.random()*3)};const g=setInterval(()=>{ue.value?Ee.value={pedestrians:Math.floor(Math.random()*5),vehicles:Math.floor(Math.random()*8),bicycles:Math.floor(Math.random()*3)}:clearInterval(g)},3e3)},et=()=>{const g=["녹색","황색","적색"];let u=0;const v=setInterval(()=>{ue.value?(Ne.value=g[u],u=(u+1)%g.length):clearInterval(v)},5e3)},tn=()=>{const g=()=>{if(!ue.value)return;const v=Math.random();if(v<.7)Ce.value={inODD:!0,distanceToBoundary:Math.floor(Math.random()*2e3)+500,approachingBoundary:!1,etaToBoundary:0,recommendedAction:"정상 운행 유지",weather:["맑음","흐림"][Math.floor(Math.random()*2)],lighting:ue.value.currentTime==="night"?"야간":"주간",roadCondition:"건조",temperature:Math.floor(Math.random()*10)+18,systemLimits:{oddExceeded:!1,sensorFailure:!1,weatherLimit:!1,gpsLoss:!1},driverInterventionRequired:!1,interventionReason:"",safetyStopAvailable:!0};else if(v<.9){const I=Math.floor(Math.random()*300)+100;Ce.value={inODD:!0,distanceToBoundary:I,approachingBoundary:!0,etaToBoundary:Math.floor(I/10),recommendedAction:"속도 감소 및 경로 확인",weather:["비","안개"][Math.floor(Math.random()*2)],lighting:"주간",roadCondition:"습윤",temperature:Math.floor(Math.random()*5)+15,systemLimits:{oddExceeded:!1,sensorFailure:!1,weatherLimit:I<200,gpsLoss:!1},driverInterventionRequired:I<150,interventionReason:I<150?"ODD 경계 접근":"",safetyStopAvailable:!0}}else Ce.value={inODD:!1,distanceToBoundary:0,approachingBoundary:!1,etaToBoundary:0,recommendedAction:"즉시 운전자 개입 필요",weather:["폭우","눈"][Math.floor(Math.random()*2)],lighting:"야간",roadCondition:["결빙","침수"][Math.floor(Math.random()*2)],temperature:Math.floor(Math.random()*5)-2,systemLimits:{oddExceeded:!0,sensorFailure:Math.random()>.5,weatherLimit:!0,gpsLoss:Math.random()>.7},driverInterventionRequired:!0,interventionReason:"시스템 한계 도달",safetyStopAvailable:Math.random()>.3}};g();const u=setInterval(()=>{ue.value?g():clearInterval(u)},1e4)},qt=g=>{if(c.value&&g.current_latitude&&g.current_longitude){c.value.setView([g.current_latitude,g.current_longitude],15);const u=l.value.get(g.id);u&&u.openPopup()}},wn=g=>{switch(g){case"SCHEDULED":return"예약됨";case"IN_PROGRESS":return"운행중";case"RETURNING":return"차고지 복귀중";case"COMPLETED":return"완료";case"CANCELLED":return"취소됨";default:return"알 수 없음"}},dn=(g,u)=>!g||!u?"N/A":`${g.toFixed(4)}, ${u.toFixed(4)}`,Li=()=>{console.log(`업데이트 주기를 ${J.value}ms로 변경`),P&&clearInterval(P),P=setInterval(re,J.value)},Ye=g=>g.tripType==="ON_DEMAND"?B.value.find(u=>u.vehicle_id===g.id):g.tripType==="SCHEDULED"?A.value.find(u=>u.vehicle_id===g.id):null,Ii=g=>({SCHEDULED:"text-blue-600",IN_PROGRESS:"text-green-600 font-medium",RETURNING:"text-orange-600 font-medium",COMPLETED:"text-gray-500",CANCELLED:"text-red-600"})[g||""]||"text-gray-500",ii=g=>{if(!g)return"-";try{return new Date(g).toLocaleString("ko-KR",{month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"})}catch{return g}},si=g=>{if(!g)return"-";try{return g.match(/^\d{2}:\d{2}$/)?g:new Date(g).toLocaleTimeString("ko-KR",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch{return g}},zn=g=>{if(g.start_node&&typeof g.start_node=="object")return g.start_node.name||`정류장 #${g.start_node.id}`;if(g.start_node_id)return`정류장 #${g.start_node_id}`;const u=g.pickup_address||g.origin_address||g.from_address;if(u)return u;const v=g.pickup_latitude||g.pickup_lat||g.origin_latitude||g.origin_lat,I=g.pickup_longitude||g.pickup_lng||g.pickup_lon||g.origin_longitude||g.origin_lng||g.origin_lon;return v!==void 0&&I!==void 0&&v!==null&&I!==null?`${Number(v).toFixed(4)}, ${Number(I).toFixed(4)}`:"위치 정보 없음"},Ui=g=>{if(g.end_node&&typeof g.end_node=="object")return g.end_node.name||`정류장 #${g.end_node.id}`;if(g.end_node_id)return`정류장 #${g.end_node_id}`;const u=g.dropoff_address||g.destination_address||g.to_address;if(u)return u;const v=g.dropoff_latitude||g.dropoff_lat||g.destination_latitude||g.destination_lat,I=g.dropoff_longitude||g.dropoff_lng||g.dropoff_lon||g.destination_longitude||g.destination_lng||g.destination_lon;return v!==void 0&&I!==void 0&&v!==null&&I!==null?`${Number(v).toFixed(4)}, ${Number(I).toFixed(4)}`:"위치 정보 없음"},as=g=>{if(!g)return"-";try{const u=new Date(g),I=new Date().getTime()-u.getTime(),z=Math.floor(I/6e4);if(z<60)return`${z}분`;{const V=Math.floor(z/60),W=z%60;return`${V}시간 ${W}분`}}catch{return"-"}},qs=async g=>{if(!g.trip_id){alert("Trip ID가 없습니다.");return}if(confirm(`차량 ${g.vehicle_number}의 운행을 중단하시겠습니까?\\n\\n운행이 완료 처리되며 차량이 차고지로 복귀합니다.`))try{O.value=!0;const v=g.tripType||"SCHEDULED";console.log(`차량 ${g.id}: IN_PROGRESS → COMPLETED 상태 전환 시도`);const I=await fetch(`${a}/api/planning/trips/${g.trip_id}/status?trip_type=${v}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:"COMPLETED"})});if(I.ok)console.log(`차량 ${g.id} 운행 완료 처리됨`),await re(),alert("운행이 완료 처리되었습니다.");else{const z=await I.text();if(console.error("운행완료 처리 실패:",I.status,z),I.status===400&&z.includes("상태 전환")){console.log("CANCELLED 상태로 시도");const V=await fetch(`${a}/api/planning/trips/${g.trip_id}/status?trip_type=${v}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:"CANCELLED"})});if(V.ok)console.log(`차량 ${g.id} 운행 취소됨`),await re(),alert("운행이 취소되었습니다.");else{const W=await V.text();console.error("운행취소도 실패:",V.status,W),alert(`운행중단 실패:\\n1. COMPLETED 전환 실패: ${z}\\n2. CANCELLED 전환 실패: ${W}`)}}else alert(`운행중단 실패: ${I.status} - ${z}`)}}catch(v){console.error("운행중단 오류:",v),alert(`운행중단 중 오류가 발생했습니다: ${v.message}`)}finally{O.value=!1}},js=async g=>{if(!g.trip_id){alert("Trip ID가 없습니다.");return}if(confirm(`차량 ${g.vehicle_number}의 복귀를 완료하시겠습니까?`))try{if(O.value=!0,g.tripType==="ON_DEMAND"){const v=await fetch(`${a}/api/driver/trips/${g.trip_id}/return-complete`,{method:"POST",headers:{"Content-Type":"application/json"}});if(v.ok)console.log(`수요응답 차량 ${g.id} 복귀 완료`),await re(),alert("복귀가 완료되었습니다.");else{const I=await v.text();console.error("복귀완료 실패:",v.status,I),alert(`복귀완료 실패: ${v.status} - ${I}`)}}else{const v=g.tripType||"SCHEDULED",I=await fetch(`${a}/api/planning/trips/${g.trip_id}/status?trip_type=${v}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:"COMPLETED"})});if(I.ok)console.log(`정기노선 차량 ${g.id} 복귀 완료`),await re(),alert("복귀가 완료되었습니다.");else{const z=await I.text();console.error("복귀완료 실패:",I.status,z),alert(`복귀완료 실패: ${I.status} - ${z}`)}}}catch(v){console.error("복귀완료 오류:",v),alert(`복귀완료 중 오류가 발생했습니다: ${v.message}`)}finally{O.value=!1}},Ni=g=>{g===1?Q.value=!Q.value:g===2?te.value=!te.value:g===3&&(ve.value=!ve.value)},Oi=g=>{g===1?(ke.value=!1,Y.value&&Y.value.pause()):g===2?(rt.value=!1,oe.value&&oe.value.pause()):g===3&&(Je.value=!1,$.value&&$.value.pause())},Fi=(g,u)=>{if(g.target.closest(".pip-header")){X.value=u;let v;if(u===1?v=q.value:u===2?v=j.value:u===3&&(v=ie.value),v){const I=v.getBoundingClientRect();ce.value={x:g.clientX-I.left,y:g.clientY-I.top},document.addEventListener("mousemove",os),document.addEventListener("mouseup",y)}}},os=g=>{if(X.value!==null){let u;if(X.value===1?u=q.value:X.value===2?u=j.value:X.value===3&&(u=ie.value),u){const v=g.clientX-ce.value.x,I=g.clientY-ce.value.y,z=window.innerWidth-u.offsetWidth,V=window.innerHeight-u.offsetHeight;u.style.left=`${Math.max(0,Math.min(v,z))}px`,u.style.top=`${Math.max(0,Math.min(I,V))}px`}}},y=()=>{X.value=null,document.removeEventListener("mousemove",os),document.removeEventListener("mouseup",y)},F=()=>{setTimeout(()=>{Y.value&&(Y.value.currentTime=0,Y.value.play())},100),setTimeout(()=>{oe.value&&(oe.value.currentTime=5,oe.value.play())},500),setTimeout(()=>{$.value&&($.value.currentTime=10,$.value.play())},1e3)};return Zo(async()=>{b.value=!0;try{ye(),await ee(),console.log("초기 데이터 로드 완료")}catch(g){console.error("초기 데이터 로드 실패:",g),C.value=g.message||"데이터 로드 중 오류가 발생했습니다."}finally{b.value=!1}F(),P=setInterval(re,J.value)}),Nl(()=>{P&&clearInterval(P),c.value&&c.value.remove()}),(g,u)=>(Ue(),Ie("div",mm,[E("div",gm,[u[17]||(u[17]=E("h1",{class:"text-2xl font-bold text-gray-800"},"실시간 차량 위치 추적",-1)),E("div",_m,[E("div",vm,[u[10]||(u[10]=E("div",{class:"w-3 h-3 bg-blue-500 rounded-full"},null,-1)),E("span",xm,"정기노선 ("+Me(Qe.value)+"대)",1)]),E("div",Mm,[u[11]||(u[11]=E("div",{class:"w-3 h-3 bg-green-500 rounded-full"},null,-1)),E("span",Sm,"수요응답 ("+Me(De.value)+"대)",1)]),E("div",ym,[u[12]||(u[12]=E("div",{class:"w-3 h-3 bg-orange-500 rounded-full"},null,-1)),E("span",Em,"차고지 복귀 중 ("+Me(lt.value)+"대)",1)]),E("div",Tm,[u[13]||(u[13]=E("div",{class:"w-3 h-3 bg-gray-400 rounded-full"},null,-1)),E("span",bm,"전체 차량 ("+Me(U.value.length)+"대)",1)]),E("div",Am,[E("span",null,"마지막 업데이트: "+Me(L.value),1),E("div",{class:Et(["w-2 h-2 rounded-full transition-all duration-300",O.value?"bg-blue-500 animate-pulse":"bg-transparent"]),title:"업데이트 상태"},null,2)]),E("div",wm,[u[16]||(u[16]=E("label",{class:"text-sm text-gray-600"},"업데이트 주기:",-1)),Xi(E("select",{"onUpdate:modelValue":u[0]||(u[0]=v=>J.value=v),onChange:Li,class:"text-sm border border-gray-300 rounded px-2 py-1"},u[14]||(u[14]=[E("option",{value:1e3},"1초 (실시간)",-1),E("option",{value:3e3},"3초",-1),E("option",{value:5e3},"5초",-1),E("option",{value:1e4},"10초",-1),E("option",{value:3e4},"30초",-1)]),544),[[Ol,J.value]]),J.value===1e3?(Ue(),Ie("div",Rm,u[15]||(u[15]=[E("span",null,"⚡ 실시간 모드",-1)]))):Ke("",!0),E("button",{onClick:Se,disabled:b.value||O.value,class:"px-3 py-1 bg-blue-500 text-white text-sm rounded hover:bg-blue-600 disabled:opacity-50",style:{"min-width":"100px"}},Me(b.value?"로딩 중...":"새로고침"),9,Cm)])])]),E("div",Pm,[E("div",Dm,[E("div",{ref_key:"mapContainer",ref:o,class:"w-full h-full"},null,512),Xi(E("div",{ref_key:"pip1Container",ref:q,class:Et(["pip-video-container pip-1",{"pip-minimized":Q.value,"pip-selected":ne.value===0}]),onMousedown:u[3]||(u[3]=v=>Fi(v,1))},[E("div",Lm,[u[21]||(u[21]=E("span",{class:"pip-title"},"3D 시뮬레이션 (Chase)",-1)),E("div",Im,[E("button",{onClick:u[1]||(u[1]=v=>Ni(1)),class:"pip-btn",title:"크기 조절"},[Q.value?(Ue(),Ie("svg",Um,u[18]||(u[18]=[E("path",{d:"M3 3v10h10V3H3zm9 9H4V4h8v8z"},null,-1)]))):(Ue(),Ie("svg",Nm,u[19]||(u[19]=[E("path",{d:"M4 4h3v1H5v2H4V4zm5 0h3v3h-1V5H9V4zM4 9h1v2h2v1H4V9zm8 0h1v3H9v-1h3V9z"},null,-1)])))]),E("button",{onClick:u[2]||(u[2]=v=>Oi(1)),class:"pip-btn",title:"닫기"},u[20]||(u[20]=[E("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor"},[E("path",{d:"M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"})],-1)]))])]),Ba(Yo,{width:Q.value?320:640,height:Q.value?200:400,cameraMode:"chase"},null,8,["width","height"])],34),[[Ks,ke.value]]),Xi(E("div",{ref_key:"pip2Container",ref:j,class:Et(["pip-video-container pip-2",{"pip-minimized":te.value,"pip-selected":ne.value===1}]),onMousedown:u[6]||(u[6]=v=>Fi(v,2))},[E("div",Om,[u[25]||(u[25]=E("span",{class:"pip-title"},"3D 시뮬레이션 (Top)",-1)),E("div",Fm,[E("button",{onClick:u[4]||(u[4]=v=>Ni(2)),class:"pip-btn",title:"크기 조절"},[te.value?(Ue(),Ie("svg",Bm,u[22]||(u[22]=[E("path",{d:"M3 3v10h10V3H3zm9 9H4V4h8v8z"},null,-1)]))):(Ue(),Ie("svg",Vm,u[23]||(u[23]=[E("path",{d:"M4 4h3v1H5v2H4V4zm5 0h3v3h-1V5H9V4zM4 9h1v2h2v1H4V9zm8 0h1v3H9v-1h3V9z"},null,-1)])))]),E("button",{onClick:u[5]||(u[5]=v=>Oi(2)),class:"pip-btn",title:"닫기"},u[24]||(u[24]=[E("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor"},[E("path",{d:"M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"})],-1)]))])]),Ba(Yo,{width:te.value?320:640,height:te.value?200:400,cameraMode:"top"},null,8,["width","height"])],34),[[Ks,rt.value]]),Xi(E("div",{ref_key:"pip3Container",ref:ie,class:Et(["pip-video-container pip-3",{"pip-minimized":ve.value,"pip-selected":ne.value===2}]),onMousedown:u[9]||(u[9]=v=>Fi(v,3))},[E("div",zm,[u[29]||(u[29]=E("span",{class:"pip-title"},"차량 내부 영상",-1)),E("div",km,[E("button",{onClick:u[7]||(u[7]=v=>Ni(3)),class:"pip-btn",title:"크기 조절"},[ve.value?(Ue(),Ie("svg",Hm,u[26]||(u[26]=[E("path",{d:"M3 3v10h10V3H3zm9 9H4V4h8v8z"},null,-1)]))):(Ue(),Ie("svg",Gm,u[27]||(u[27]=[E("path",{d:"M4 4h3v1H5v2H4V4zm5 0h3v3h-1V5H9V4zM4 9h1v2h2v1H4V9zm8 0h1v3H9v-1h3V9z"},null,-1)])))]),E("button",{onClick:u[8]||(u[8]=v=>Oi(3)),class:"pip-btn",title:"닫기"},u[28]||(u[28]=[E("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor"},[E("path",{d:"M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"})],-1)]))])]),E("video",{ref_key:"video3Player",ref:$,class:"pip-video",src:"/generated.mp4",controls:"",autoplay:"",loop:"",muted:""},null,512)],34),[[Ks,Je.value]]),ue.value&&ne.value!==null?(Ue(),Ie("div",{key:0,class:Et(["vehicle-info-panel",{"panel-expanded":ne.value!==null}])},[E("div",{class:"panel-header"},[u[31]||(u[31]=E("h3",{class:"panel-title"},"차량 상세 정보",-1)),E("button",{onClick:He,class:"close-btn"},u[30]||(u[30]=[E("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"currentColor"},[E("path",{d:"M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"})],-1)]))]),E("div",Wm,[E("div",Xm,[u[36]||(u[36]=E("h4",{class:"section-title"},"차량 정보",-1)),E("div",$m,[E("div",qm,[u[32]||(u[32]=E("span",{class:"info-label"},"차량 번호",-1)),E("span",jm,Me(ue.value.vehicle_number),1)]),E("div",Ym,[u[33]||(u[33]=E("span",{class:"info-label"},"차량 ID",-1)),E("span",Km,"#"+Me(ue.value.id),1)]),E("div",Zm,[u[34]||(u[34]=E("span",{class:"info-label"},"운행 타입",-1)),E("span",{class:Et(["info-value",ue.value.tripType==="SCHEDULED"?"text-blue-600":"text-green-600"])},Me(ue.value.tripType==="SCHEDULED"?"정기노선":"수요응답"),3)]),E("div",Jm,[u[35]||(u[35]=E("span",{class:"info-label"},"상태",-1)),E("span",{class:Et(["info-value",Ii(ue.value.tripStatus)])},Me(wn(ue.value.tripStatus)),3)])])]),E("div",Qm,[u[41]||(u[41]=E("h4",{class:"section-title"},"운행 정보",-1)),E("div",eg,[E("div",tg,[u[37]||(u[37]=E("span",{class:"info-label"},"Trip ID",-1)),E("span",ng,"#"+Me(ue.value.trip_id),1)]),E("div",ig,[u[38]||(u[38]=E("span",{class:"info-label"},"승객",-1)),E("span",sg,Me(ue.value.current_occupancy||0)+"/"+Me(ue.value.capacity||0)+"명",1)]),ue.value.driver_id?(Ue(),Ie("div",rg,[u[39]||(u[39]=E("span",{class:"info-label"},"운전자 ID",-1)),E("span",ag,"#"+Me(ue.value.driver_id),1)])):Ke("",!0),ue.value.route_id?(Ue(),Ie("div",og,[u[40]||(u[40]=E("span",{class:"info-label"},"노선 ID",-1)),E("span",lg,"#"+Me(ue.value.route_id),1)])):Ke("",!0)])]),E("div",cg,[u[47]||(u[47]=E("h4",{class:"section-title"},"위치 정보",-1)),E("div",dg,[E("div",ug,[u[42]||(u[42]=E("span",{class:"info-label"},"현재 좌표",-1)),E("span",hg,Me(dn(ue.value.current_latitude,ue.value.current_longitude)),1)]),E("div",fg,[u[43]||(u[43]=E("span",{class:"info-label"},"속도",-1)),E("span",pg,Me(ue.value.speed||0)+" km/h",1)]),E("div",mg,[u[44]||(u[44]=E("span",{class:"info-label"},"방향",-1)),E("span",gg,Me(ue.value.heading||0)+"°",1)]),ue.value.last_node_id?(Ue(),Ie("div",_g,[u[45]||(u[45]=E("span",{class:"info-label"},"마지막 노드",-1)),E("span",vg,"#"+Me(ue.value.last_node_id),1)])):Ke("",!0),ue.value.current_link_id?(Ue(),Ie("div",xg,[u[46]||(u[46]=E("span",{class:"info-label"},"현재 링크",-1)),E("span",Mg,"#"+Me(ue.value.current_link_id),1)])):Ke("",!0)])]),E("div",Sg,[u[56]||(u[56]=E("h4",{class:"section-title"},"객체 감지 정보",-1)),E("div",yg,[E("div",Eg,[u[49]||(u[49]=E("div",{class:"detection-icon pedestrian"},null,-1)),E("div",Tg,[u[48]||(u[48]=E("span",{class:"detection-label"},"보행자",-1)),E("span",bg,Me(Ee.value.pedestrians||0),1)])]),E("div",Ag,[u[51]||(u[51]=E("div",{class:"detection-icon vehicle"},null,-1)),E("div",wg,[u[50]||(u[50]=E("span",{class:"detection-label"},"차량",-1)),E("span",Rg,Me(Ee.value.vehicles||0),1)])]),E("div",Cg,[u[53]||(u[53]=E("div",{class:"detection-icon bicycle"},null,-1)),E("div",Pg,[u[52]||(u[52]=E("span",{class:"detection-label"},"자전거",-1)),E("span",Dg,Me(Ee.value.bicycles||0),1)])]),E("div",Lg,[u[55]||(u[55]=E("div",{class:"detection-icon signal"},null,-1)),E("div",Ig,[u[54]||(u[54]=E("span",{class:"detection-label"},"신호등",-1)),E("span",{class:Et(["detection-status",dt.value])},Me(Ne.value),3)])])])]),u[80]||(u[80]=Fa('<div class="info-section" data-v-3cf517d4><h4 class="section-title" data-v-3cf517d4>센서 데이터</h4><div class="sensor-grid" data-v-3cf517d4><div class="sensor-item" data-v-3cf517d4><span class="sensor-label" data-v-3cf517d4>LiDAR</span><div class="sensor-bar" data-v-3cf517d4><div class="sensor-fill" style="width:85%;" data-v-3cf517d4></div></div><span class="sensor-value" data-v-3cf517d4>정상</span></div><div class="sensor-item" data-v-3cf517d4><span class="sensor-label" data-v-3cf517d4>Camera</span><div class="sensor-bar" data-v-3cf517d4><div class="sensor-fill" style="width:92%;" data-v-3cf517d4></div></div><span class="sensor-value" data-v-3cf517d4>정상</span></div><div class="sensor-item" data-v-3cf517d4><span class="sensor-label" data-v-3cf517d4>GPS</span><div class="sensor-bar" data-v-3cf517d4><div class="sensor-fill" style="width:98%;" data-v-3cf517d4></div></div><span class="sensor-value" data-v-3cf517d4>정상</span></div><div class="sensor-item" data-v-3cf517d4><span class="sensor-label" data-v-3cf517d4>IMU</span><div class="sensor-bar" data-v-3cf517d4><div class="sensor-fill" style="width:90%;" data-v-3cf517d4></div></div><span class="sensor-value" data-v-3cf517d4>정상</span></div></div></div>',1)),E("div",Ug,[u[79]||(u[79]=E("h4",{class:"section-title"},"ODD 운영설계영역 상태",-1)),E("div",{class:Et(["odd-status-card",Ce.value.inODD?"status-safe":"status-warning"])},[E("div",Ng,[E("span",Og,Me(Ce.value.inODD?"✅":"⚠️"),1),u[57]||(u[57]=E("span",{class:"odd-status-title"},"ODD 범위 상태",-1))]),E("div",Fg,[E("span",Bg,Me(Ce.value.inODD?"ODD 내 운행 중":"ODD 이탈"),1),Ce.value.distanceToBoundary?(Ue(),Ie("span",Vg," 경계까지: "+Me(Ce.value.distanceToBoundary)+"m ",1)):Ke("",!0)])],2),E("div",zg,[u[66]||(u[66]=E("h5",{class:"subsection-title"},"환경 조건",-1)),E("div",kg,[E("div",Hg,[u[59]||(u[59]=E("span",{class:"condition-icon"},"🌤️",-1)),E("div",Gg,[u[58]||(u[58]=E("span",{class:"condition-label"},"날씨",-1)),E("span",Wg,Me(Ce.value.weather),1)])]),E("div",Xg,[u[61]||(u[61]=E("span",{class:"condition-icon"},"☀️",-1)),E("div",$g,[u[60]||(u[60]=E("span",{class:"condition-label"},"조도",-1)),E("span",qg,Me(Ce.value.lighting),1)])]),E("div",jg,[u[63]||(u[63]=E("span",{class:"condition-icon"},"🛣️",-1)),E("div",Yg,[u[62]||(u[62]=E("span",{class:"condition-label"},"도로",-1)),E("span",Kg,Me(Ce.value.roadCondition),1)])]),E("div",Zg,[u[65]||(u[65]=E("span",{class:"condition-icon"},"🌡️",-1)),E("div",Jg,[u[64]||(u[64]=E("span",{class:"condition-label"},"온도",-1)),E("span",Qg,Me(Ce.value.temperature)+"°C",1)])])])]),E("div",e_,[u[74]||(u[74]=E("h5",{class:"subsection-title"},"시스템 한계 상황",-1)),E("div",t_,[E("div",{class:Et(["limit-item",{"limit-active":Ce.value.systemLimits.oddExceeded}])},u[67]||(u[67]=[E("span",{class:"limit-indicator"},null,-1),E("span",{class:"limit-text"},"ODD 범위 벗어남",-1)]),2),E("div",{class:Et(["limit-item",{"limit-active":Ce.value.systemLimits.sensorFailure}])},u[68]||(u[68]=[E("span",{class:"limit-indicator"},null,-1),E("span",{class:"limit-text"},"센서 장애",-1)]),2),E("div",{class:Et(["limit-item",{"limit-active":Ce.value.systemLimits.weatherLimit}])},u[69]||(u[69]=[E("span",{class:"limit-indicator"},null,-1),E("span",{class:"limit-text"},"날씨 제한",-1)]),2),E("div",{class:Et(["limit-item",{"limit-active":Ce.value.systemLimits.gpsLoss}])},u[70]||(u[70]=[E("span",{class:"limit-indicator"},null,-1),E("span",{class:"limit-text"},"GPS 신호 손실",-1)]),2)]),Ce.value.driverInterventionRequired?(Ue(),Ie("div",n_,[u[72]||(u[72]=E("div",{class:"intervention-icon"},"⚠️",-1)),E("div",i_,[u[71]||(u[71]=E("span",{class:"intervention-title"},"운전자 개입 필요",-1)),E("span",s_,Me(Ce.value.interventionReason),1)])])):Ke("",!0),E("div",{class:Et(["safety-stop-status",{active:Ce.value.safetyStopAvailable}])},[u[73]||(u[73]=E("span",{class:"safety-icon"},"🛑",-1)),E("span",r_,"안전 정차 "+Me(Ce.value.safetyStopAvailable?"가능":"불가능"),1)],2)]),Ce.value.approachingBoundary?(Ue(),Ie("div",a_,[u[78]||(u[78]=E("div",{class:"warning-header"},[E("span",{class:"warning-icon"},"⚠️"),E("span",{class:"warning-title"},"ODD 경계 접근 중")],-1)),E("div",o_,[E("div",l_,[u[75]||(u[75]=E("span",{class:"distance-label"},"경계까지 거리:",-1)),E("span",c_,Me(Ce.value.distanceToBoundary)+"m",1)]),E("div",d_,[u[76]||(u[76]=E("span",{class:"eta-label"},"예상 도달 시간:",-1)),E("span",u_,Me(Ce.value.etaToBoundary)+"초",1)]),E("div",h_,[u[77]||(u[77]=E("span",{class:"action-label"},"권장 조치",-1)),E("span",f_,Me(Ce.value.recommendedAction),1)])])])):Ke("",!0)])])],2)):Ke("",!0),u[83]||(u[83]=Fa('<div class="legend-box" data-v-3cf517d4><h4 class="font-semibold text-sm mb-2" data-v-3cf517d4>범례</h4><div class="legend-section mb-3" data-v-3cf517d4><div class="legend-title text-xs font-medium text-gray-700 mb-1" data-v-3cf517d4>경로 표시</div><div class="legend-item" data-v-3cf517d4><div class="legend-line" style="background:#0066CC;height:3px;" data-v-3cf517d4></div><span class="legend-label" data-v-3cf517d4>예정 경로 (미래)</span></div><div class="legend-item" data-v-3cf517d4><div class="legend-line" style="background:#FF0000;height:5px;" data-v-3cf517d4></div><span class="legend-label" data-v-3cf517d4>현재 주행 중인 구간</span></div><div class="legend-item" data-v-3cf517d4><div class="legend-line legend-dashed" style="background:#888888;height:3px;" data-v-3cf517d4></div><span class="legend-label" data-v-3cf517d4>이미 지나간 경로</span></div><div class="legend-item" data-v-3cf517d4><div class="legend-line legend-dashed" style="background:#FF6600;height:2px;" data-v-3cf517d4></div><span class="legend-label" data-v-3cf517d4>차량 이동 궤적</span></div></div><div class="legend-section mb-3" data-v-3cf517d4><div class="legend-title text-xs font-medium text-gray-700 mb-1" data-v-3cf517d4>차량 마커</div><div class="legend-item" data-v-3cf517d4><div class="legend-marker" style="background:#2563EB;" data-v-3cf517d4></div><span class="legend-label" data-v-3cf517d4>정기노선 차량</span></div><div class="legend-item" data-v-3cf517d4><div class="legend-marker" style="background:#059669;" data-v-3cf517d4></div><span class="legend-label" data-v-3cf517d4>수요응답 차량</span></div><div class="legend-item" data-v-3cf517d4><div class="legend-marker" style="background:#EA580C;" data-v-3cf517d4></div><span class="legend-label" data-v-3cf517d4>차고지 복귀 중</span></div></div><div class="legend-section" data-v-3cf517d4><div class="legend-title text-xs font-medium text-gray-700 mb-1" data-v-3cf517d4>정류장</div><div class="legend-item" data-v-3cf517d4><div class="legend-stop" style="background:#3B82F6;" data-v-3cf517d4></div><span class="legend-label" data-v-3cf517d4>예정 정류장</span></div><div class="legend-item" data-v-3cf517d4><div class="legend-stop" style="background:#9CA3AF;" data-v-3cf517d4></div><span class="legend-label" data-v-3cf517d4>통과한 정류장</span></div></div></div>',1)),b.value?(Ue(),Ie("div",p_,u[81]||(u[81]=[E("div",{class:"text-center"},[E("div",{class:"animate-spin rounded-full h-8 w-8 border-b-2 border-blue-500 mx-auto mb-2"}),E("p",{class:"text-gray-600"},"차량 위치 정보를 불러오는 중...")],-1)]))):Ke("",!0),C.value?(Ue(),Ie("div",m_,[u[82]||(u[82]=E("p",{class:"font-semibold"},"오류 발생",-1)),E("p",g_,Me(C.value),1)])):Ke("",!0)]),E("div",__,[E("div",v_,[u[114]||(u[114]=E("h3",{class:"text-lg font-semibold mb-4"},"운행 중 차량 목록",-1)),Ae.value.length===0?(Ue(),Ie("div",x_,u[84]||(u[84]=[E("p",null,"현재 운행 중인 차량이 없습니다.",-1)]))):(Ue(),Ie("div",M_,[(Ue(!0),Ie(Zs,null,Js(Ae.value,(v,I)=>{var z;return Ue(),Ie("div",{key:v.id,class:"vehicle-card p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors",onClick:V=>Te(v,I)},[E("div",y_,[E("div",E_,[E("div",{class:Et(["w-3 h-3 rounded-full",v.tripType==="SCHEDULED"?"bg-blue-500":v.tripType==="ON_DEMAND"?"bg-green-500":"bg-gray-500"])},null,2),E("span",T_,Me(v.vehicle_number),1)]),E("span",b_,Me(v.tripType==="SCHEDULED"?"정기노선":"수요응답"),1)]),E("div",A_,[E("div",w_,[u[85]||(u[85]=E("span",{class:"font-medium"},"차량 ID:",-1)),E("span",R_,"#"+Me(v.id),1)]),v.trip_id?(Ue(),Ie("div",C_,[E("span",P_,Me(v.tripType==="ON_DEMAND"?"Trip ID (수요응답):":"운행 ID:"),1),E("span",D_,"#"+Me(v.trip_id),1)])):Ke("",!0),v.tripType==="ON_DEMAND"?(Ue(),Ie("div",L_,[u[91]||(u[91]=E("div",{class:"font-medium text-green-800 mb-1"},"🔍 디버깅 정보",-1)),E("div",I_,[E("div",U_,[u[86]||(u[86]=E("span",null,"Trip ID:",-1)),E("span",N_,"#"+Me(v.trip_id),1)]),E("div",O_,[u[87]||(u[87]=E("span",null,"Vehicle ID:",-1)),E("span",F_,"#"+Me(v.id),1)]),Ye(v)?(Ue(),Ie("div",B_,[Ye(v).calls?(Ue(),Ie("div",V_,[u[88]||(u[88]=E("span",null,"할당된 Call 수:",-1)),E("span",z_,Me(((z=Ye(v).calls)==null?void 0:z.length)||0)+"개",1)])):Ke("",!0),Ye(v).calls&&Ye(v).calls.length>0?(Ue(),Ie("div",k_,[u[89]||(u[89]=E("span",{class:"text-green-600"},"Call IDs:",-1)),E("div",H_,[(Ue(!0),Ie(Zs,null,Js(Ye(v).calls,V=>(Ue(),Ie("span",{key:V.id,class:"px-1.5 py-0.5 bg-purple-100 text-purple-700 rounded text-xs font-mono"}," #"+Me(V.id),1))),128))])])):Ke("",!0),Ye(v).service_area_id?(Ue(),Ie("div",G_,[u[90]||(u[90]=E("span",null,"서비스 지역:",-1)),E("span",W_,"#"+Me(Ye(v).service_area_id),1)])):Ke("",!0)])):Ke("",!0)])])):Ke("",!0),E("div",X_,[u[92]||(u[92]=E("span",null,"상태:",-1)),E("span",{class:Et(Ii(v.tripStatus))},[Fl(Me(wn(v.tripStatus))+" ",1),v.tripStatus==="RETURNING"?(Ue(),Ie("span",$_," 🏠 ")):Ke("",!0)],2)]),v.tripStatus==="RETURNING"?(Ue(),Ie("div",q_,u[93]||(u[93]=[E("span",{class:"text-orange-700"},"12번 정류장 → 1번 정류장 (차고지)",-1)]))):Ke("",!0),E("div",j_,[u[94]||(u[94]=E("span",null,"승객:",-1)),E("span",{class:Et(v.current_occupancy>0?"text-orange-600 font-medium":"")},Me(v.current_occupancy||0)+"/"+Me(v.capacity||0)+"명 ",3)]),E("div",Y_,[u[95]||(u[95]=E("div",{class:"text-xs text-gray-500 mb-2"},"운행 제어",-1)),E("div",K_,[v.tripStatus==="IN_PROGRESS"?(Ue(),Ie("button",{key:0,onClick:V=>qs(v),class:"flex-1 px-2 py-1 bg-red-500 text-white text-xs rounded hover:bg-red-600 disabled:opacity-50",disabled:b.value}," 운행중단 ",8,Z_)):Ke("",!0),v.tripStatus==="RETURNING"?(Ue(),Ie("button",{key:1,onClick:V=>js(v),class:"flex-1 px-2 py-1 bg-green-500 text-white text-xs rounded hover:bg-green-600 disabled:opacity-50",disabled:b.value}," 복귀완료 ",8,J_)):Ke("",!0)])]),v.tripType==="SCHEDULED"&&Ye(v)?(Ue(),Ie("div",Q_,[u[101]||(u[101]=E("div",{class:"text-xs text-gray-500 mb-1"},"운행 정보",-1)),Ye(v).start_datetime||Ye(v).start_time?(Ue(),Ie("div",ev,[E("div",tv,[u[96]||(u[96]=E("span",{class:"text-blue-700"},"출발:",-1)),E("span",nv,Me(si(Ye(v).start_datetime||Ye(v).start_time)),1)]),E("div",iv,[u[97]||(u[97]=E("span",{class:"text-blue-700"},"도착:",-1)),E("span",sv,Me(si(Ye(v).end_datetime||Ye(v).end_time)),1)])])):Ke("",!0),Ye(v).start_time&&!Ye(v).end_time?(Ue(),Ie("div",rv,[u[98]||(u[98]=E("span",null,"운행 경과:",-1)),E("span",av,Me(as(Ye(v).start_time)),1)])):Ke("",!0),Ye(v).route_id?(Ue(),Ie("div",ov,[u[99]||(u[99]=E("span",null,"노선 ID:",-1)),E("span",lv,"#"+Me(Ye(v).route_id),1)])):Ke("",!0),Ye(v).driver_id?(Ue(),Ie("div",cv,[u[100]||(u[100]=E("span",null,"운전자:",-1)),E("span",dv,"#"+Me(Ye(v).driver_id),1)])):Ke("",!0)])):Ke("",!0),v.tripType==="ON_DEMAND"&&Ye(v)?(Ue(),Ie("div",uv,[u[109]||(u[109]=E("div",{class:"text-xs text-gray-500 mb-1"},"호출 정보",-1)),Ye(v).calls&&Ye(v).calls.length>0?(Ue(),Ie("div",hv,[E("div",fv,[u[102]||(u[102]=E("span",null,"할당 호출:",-1)),E("span",pv,Me(Ye(v).calls.length)+"개",1)]),(Ue(!0),Ie(Zs,null,Js(Ye(v).calls.slice(0,3),(V,W)=>(Ue(),Ie("div",{key:V.id,class:"bg-green-50 p-2 rounded text-xs"},[E("div",mv,"Call #"+Me(V.id),1),E("div",gv,[E("div",_v,[u[104]||(u[104]=E("span",{class:"text-green-600"},"🔵",-1)),E("div",vv,[u[103]||(u[103]=E("span",{class:"text-xs"},"픽업:",-1)),E("div",{class:"text-xs truncate",title:zn(V)},Me(zn(V)),9,xv)])]),E("div",Mv,[u[106]||(u[106]=E("span",{class:"text-red-600"},"🔴",-1)),E("div",Sv,[u[105]||(u[105]=E("span",{class:"text-xs"},"드롭:",-1)),E("div",{class:"text-xs truncate",title:Ui(V)},Me(Ui(V)),9,yv)])]),V.requested_pickup_time?(Ue(),Ie("div",Ev," 요청시간: "+Me(si(V.requested_pickup_time)),1)):Ke("",!0)])]))),128)),Ye(v).calls.length>3?(Ue(),Ie("div",Tv," ... 외 "+Me(Ye(v).calls.length-3)+"개 호출 ",1)):Ke("",!0)])):Ke("",!0),Ye(v).service_area_id?(Ue(),Ie("div",bv,[u[107]||(u[107]=E("span",null,"서비스 지역:",-1)),E("span",Av,"#"+Me(Ye(v).service_area_id),1)])):Ke("",!0),Ye(v).driver_id?(Ue(),Ie("div",wv,[u[108]||(u[108]=E("span",null,"운전자:",-1)),E("span",Rv,"#"+Me(Ye(v).driver_id),1)])):Ke("",!0)])):Ke("",!0),E("div",Cv,[u[113]||(u[113]=E("div",{class:"text-xs text-gray-500 mb-1"},"위치 정보",-1)),E("div",Pv,[u[110]||(u[110]=E("span",null,"좌표:",-1)),E("span",Dv,Me(dn(v.current_latitude,v.current_longitude)),1)]),v.last_node_id?(Ue(),Ie("div",Lv,[u[111]||(u[111]=E("span",null,"마지막 노드:",-1)),E("span",Iv,"#"+Me(v.last_node_id),1)])):Ke("",!0),v.current_link_id?(Ue(),Ie("div",Uv,[u[112]||(u[112]=E("span",null,"현재 링크:",-1)),E("span",Nv,"#"+Me(v.current_link_id),1)])):Ke("",!0)])])],8,S_)}),128))]))])])])]))}}),qv=Jo(Ov,[["__scopeId","data-v-3cf517d4"]]);export{qv as default};
