import{B as be,l as c,d as Ge,c as te,J as Me,a as r,t as e,x as A,D as b,E as N,z as ae,F as G,f as M,C as W,v as p,H as ie,u as fe,N as de,o}from"./vendor-C2HvWOl7.js";import{j as le,_ as Pe}from"./index-YkfLyAj4.js";import{b as we}from"./menus-api-Dm7v5teQ.js";import{b as Ne}from"./menu-api-endpoints-api-6RZepQX5.js";const Ce=be("menuApiEndpoints",()=>{const E=c([]),l=c(!1),_=c(null),I=new Ne(le()),f=async s=>{try{l.value=!0,_.value=null,console.log("📡 Loading menu API endpoints for menu:",s);const m=await I.getMenuApiEndpointsApiMenusMenuIdApiEndpointsGet(s);m.data?(E.value=Array.isArray(m.data)?m.data:[m.data],console.log("✅ Loaded menu API endpoints:",E.value)):E.value=[]}catch(m){console.error("❌ Failed to load menu API endpoints:",m),_.value=`메뉴 API 엔드포인트 조회 실패: ${m.message}`,E.value=[]}finally{l.value=!1}};return{endpoints:E,loading:l,error:_,loadMenuApiEndpoints:f,searchMenuApiEndpoints:async(s,m,n)=>{try{l.value=!0,_.value=null,console.log("📡 Searching menu API endpoints:",{path:s,method:m,menuId:n});const u=await I.searchMenuApiEndpointsApiMenusApiEndpointsSearchGet(s,m,n);if(u.data){const w=Array.isArray(u.data)?u.data:[u.data];return console.log("✅ Found menu API endpoints:",w),w}return[]}catch(u){return console.error("❌ Failed to search menu API endpoints:",u),_.value=`메뉴 API 엔드포인트 검색 실패: ${u.message}`,[]}finally{l.value=!1}},createMenuApiEndpoint:async(s,m)=>{try{l.value=!0,_.value=null,console.log("📡 Creating menu API endpoint:",s,m);const n=await I.createMenuApiEndpointApiMenusMenuIdApiEndpointsPost(s,m);return console.log("✅ Created menu API endpoint:",n.data),await f(s),n.data}catch(n){throw console.error("❌ Failed to create menu API endpoint:",n),_.value=`메뉴 API 엔드포인트 생성 실패: ${n.message}`,n}finally{l.value=!1}},updateMenuApiEndpoint:async(s,m,n)=>{try{l.value=!0,_.value=null,console.log("📡 Updating menu API endpoint:",s,m,n);const u=await I.updateMenuApiEndpointApiMenusMenuIdApiEndpointsEndpointIdPut(s,m,n);return console.log("✅ Updated menu API endpoint:",u.data),await f(s),u.data}catch(u){throw console.error("❌ Failed to update menu API endpoint:",u),_.value=`메뉴 API 엔드포인트 수정 실패: ${u.message}`,u}finally{l.value=!1}},deleteMenuApiEndpoint:async(s,m)=>{try{l.value=!0,_.value=null,console.log("📡 Deleting menu API endpoint:",s,m),await I.deleteMenuApiEndpointApiMenusMenuIdApiEndpointsEndpointIdDelete(s,m),console.log("✅ Deleted menu API endpoint"),await f(s)}catch(n){throw console.error("❌ Failed to delete menu API endpoint:",n),_.value=`메뉴 API 엔드포인트 삭제 실패: ${n.message}`,n}finally{l.value=!1}},httpMethods:["GET","POST","PUT","DELETE","PATCH"],getMethodColor:s=>({GET:"#10b981",POST:"#3b82f6",PUT:"#f59e0b",DELETE:"#ef4444",PATCH:"#8b5cf6"})[s]||"#6b7280",hasWildcard:s=>s.includes("*")}}),se=[{path:"/api/auth/token",method:"POST",summary:"사용자 로그인 및 토큰 발급",description:"운전자앱/관리자가 로그인하여 JWT 토큰을 발급받습니다",operationId:"login_for_access_token_api_auth_token_post",tags:["auth"]},{path:"/api/auth/login",method:"POST",summary:"사용자 로그인 (별칭)",description:"토큰 엔드포인트의 별칭 - 일반적인 REST API 패턴 지원",operationId:"login_alias_api_auth_login_post",tags:["auth"]},{path:"/api/auth/logout",method:"POST",summary:"로그아웃",description:"로그아웃 이벤트를 기록합니다",operationId:"logout_api_auth_logout_post",tags:["auth"]},{path:"/api/users",method:"POST",summary:"Create User",description:"",operationId:"create_user_api_users_post",tags:["users"]},{path:"/api/users",method:"GET",summary:"Get Users",description:`사용자 목록 조회
...
Returns:
    현재 연결 상태 정보`,operationId:"get_websocket_status_api_websocket_status_get",tags:["websocket"]},{path:"/api/health",method:"GET",summary:"Health Check",description:"시스템 상태 및 DB 연결 풀 상태 확인",operationId:"health_check_api_health_get",tags:["monitoring"]},{path:"/",method:"GET",summary:"프론트엔드 리다이렉트",description:"루트 경로 접속 시 정적 HTML 페이지로 리다이렉트",operationId:"read_root__get",tags:["system"]},{path:"/api/version",method:"GET",summary:"시스템 버전 정보",description:"현재 배포된 시스템의 Git 커밋 정보 조회",operationId:"get_version_api_version_get",tags:["system"]}];function Se(){return se}function Re(E){if(!E)return se;const l=E.toLowerCase();return se.filter(_=>_.path.toLowerCase().includes(l)||_.method.toLowerCase().includes(l)||_.summary.toLowerCase().includes(l)||_.description.toLowerCase().includes(l)||_.operationId.toLowerCase().includes(l)||_.tags.some(I=>I.toLowerCase().includes(l)))}const Oe={class:"menu-management"},Le={class:"filters-section"},Ue={class:"filter-group"},Ve={key:0,class:"menu-tree"},We={class:"tree-container"},He={class:"node-content"},Fe={class:"node-info"},$e=["onClick"],xe={key:1,class:"expand-icon",style:{visibility:"hidden"}},Be={class:"menu-icon"},Qe={class:"menu-name"},Je={class:"menu-path"},ze={class:"menu-order"},je={class:"node-actions"},Ke=["onClick"],qe=["onClick"],Ye=["onClick"],Xe=["onClick"],Ze=["onClick"],et={key:0,class:"tree-children"},tt={class:"node-content"},at={class:"node-info"},it=["onClick"],st={key:1,class:"expand-icon",style:{visibility:"hidden"}},nt={class:"menu-icon"},rt={class:"menu-name"},ot={class:"menu-path"},pt={class:"menu-order"},_t={class:"node-actions"},dt=["onClick"],lt=["onClick"],ct=["onClick"],mt=["onClick"],ut=["onClick"],ht={key:0,class:"tree-children"},gt={class:"node-content"},vt={class:"node-info"},It={class:"menu-icon"},yt={class:"menu-name"},Et={class:"menu-path"},Tt={class:"menu-order"},kt={class:"node-actions"},Dt=["onClick"],At=["onClick"],bt=["onClick"],Gt=["onClick"],Mt={key:1,class:"loading-container"},ft={key:2,class:"empty-state"},Pt={class:"modal-content"},wt={class:"modal-header"},Nt={class:"modal-body"},Ct={class:"form-group"},St={class:"form-group"},Rt={class:"form-group"},Ot={class:"form-group"},Lt=["value"],Ut={class:"form-group"},Vt={class:"form-actions"},Wt=["disabled"],Ht={class:"modal-content"},Ft={class:"modal-header"},$t={class:"modal-body"},xt={class:"permission-grid"},Bt=["checked","onChange"],Qt={class:"form-actions"},Jt=["disabled"],zt={class:"modal-content modal-large"},jt={class:"modal-header"},Kt={class:"modal-body"},qt={class:"endpoint-form"},Yt={class:"endpoint-filters"},Xt={class:"form-group"},Zt={class:"form-group"},ea=["value"],ta={class:"form-group"},aa=["value"],ia={class:"available-endpoints-list"},sa={class:"available-endpoints-count"},na={class:"available-endpoints-scroll"},ra=["onClick"],oa={class:"endpoint-detail"},pa={class:"endpoint-path"},_a={class:"endpoint-summary"},da=["disabled"],la={class:"endpoints-list"},ca={key:0,class:"empty-message"},ma={key:1,class:"endpoint-items"},ua={class:"endpoint-info"},ha={class:"endpoint-path"},ga={class:"endpoint-desc"},va=["onClick"],Ia=Ge({__name:"MenuManagementView",setup(E){const l=new we(le()),_=Ce(),I=c([]),f=c([]),C=c(!1),T=c(!1),z=c(null),S=c(""),k=c(new Set),j=c(),R=c(!1),s=c({name:"",path:"",icon:"",parent_id:null,sort_order:999}),m=c(!1),n=c(null),u=c(new Map),w=c(!1),P=c([]),K=c(!1),H=c([]),F=c([]),O=c(""),D=c(null),L=c(""),U=c(""),ce=["ADMIN","MANAGER","OPERATOR","DRIVER","VIEWER"],me=["GET","POST","PUT","DELETE","PATCH"],ue=te(()=>{const i=new Set;return H.value.forEach(t=>{t.tags.forEach(h=>i.add(h))}),Array.from(i).sort()}),ne=te(()=>{const i=I.value.filter(g=>{var a;if(S.value){const y=S.value.toLowerCase();if(!g.name.toLowerCase().includes(y)&&!((a=g.path)!=null&&a.toLowerCase().includes(y)))return!1}return!0}),t=i.filter(g=>!g.parent_id),h=g=>i.filter(a=>a.parent_id===g).map(a=>({...a,children:h(a.id)})).sort((a,y)=>(a.sort_order||999)-(y.sort_order||999));return t.map(g=>({...g,children:h(g.id)})).sort((g,a)=>(g.sort_order||999)-(a.sort_order||999))}),he=te(()=>I.value.filter(i=>{let t=0,h=i;for(;h.parent_id&&t<2;)h=I.value.find(g=>g.id===h.parent_id)||h,t++;return t<2}).map(i=>{const t=i.parent_id?I.value.find(h=>h.id===i.parent_id):null;return{...i,parent_name:t==null?void 0:t.name}})),$=async()=>{try{C.value=!0,z.value=null;const i=await l.getMenusApiMenusGet();if(i.data){const t=Array.isArray(i.data)?i.data:i.data.items||[];I.value=t,t.filter(h=>!h.parent_id).forEach(h=>k.value.add(h.id))}await re()}catch(i){console.error("Failed to load menus:",i),z.value=i.message}finally{C.value=!1}},re=async()=>{try{const i=[],t=["ADMIN","CONTROLLER","DRIVER"];for(const h of t)try{const g=await l.getRoleMenuPermissionsApiMenusPermissionsRoleGet(h);g.data&&g.data.permissions&&i.push(...g.data.permissions)}catch{}i.length>0&&(f.value=i)}catch(i){console.error("Failed to load permissions:",i)}},x=i=>{i?s.value={id:i.id,name:i.name,path:i.path,icon:i.icon,parent_id:i.parent_id,sort_order:i.sort_order}:s.value={name:"",path:"",icon:"",parent_id:null,sort_order:999},R.value=!0},oe=i=>{s.value={name:"",path:i.path+"/",icon:"",parent_id:i.id,sort_order:999},R.value=!0},B=()=>{R.value=!1,s.value={}},ge=async()=>{try{T.value=!0,s.value.id?await l.updateMenuApiMenusMenuIdPut(s.value.id,s.value):await l.createMenuApiMenusPost(s.value),B(),await $()}catch(i){console.error("Failed to save menu:",i),alert("메뉴 저장 실패: "+i.message)}finally{T.value=!1}},q=async i=>{if(confirm(`"${i.name}" 메뉴를 삭제하시겠습니까?`))try{await l.deleteMenuApiMenusMenuIdDelete(i.id),await $()}catch(t){console.error("Failed to delete menu:",t),alert("메뉴 삭제 실패: "+t.message)}},pe=i=>{k.value.has(i)?k.value.delete(i):k.value.add(i)},Y=i=>{n.value=i,u.value.clear(),f.value.filter(t=>t.menu_id===i.id).forEach(t=>{u.value.set(t.role,!0)}),m.value=!0},Q=()=>{m.value=!1,n.value=null,u.value.clear()},ve=(i,t)=>i&&u.value.get(t)||!1,Ie=(i,t)=>{if(!i)return;const h=u.value.get(t)||!1;u.value.set(t,!h)},ye=async()=>{if(n.value)try{T.value=!0;for(const[i,t]of u.value.entries())t&&await l.createRoleMenuPermissionApiMenusRolePermissionsPost({role:i,menu_id:n.value.id,can_view:!0,can_create:!1,can_update:!1,can_delete:!1});await re(),Q()}catch(i){console.error("Failed to save permissions:",i),alert("권한 저장 실패: "+i.message)}finally{T.value=!1}},Ee=i=>({ADMIN:"관리자",MANAGER:"매니저",OPERATOR:"운영자",DRIVER:"운전자",VIEWER:"조회자"})[i]||i,Te=()=>{clearTimeout(j.value),j.value=setTimeout(()=>{},300)},X=async i=>{n.value=i,w.value=!0,await _.loadMenuApiEndpoints(i.id),P.value=_.endpoints,H.value=Se(),O.value="",L.value="",U.value="",D.value=null,J()},Z=()=>{w.value=!1,n.value=null,P.value=[],H.value=[],F.value=[]},J=()=>{let i=H.value;O.value&&(i=Re(O.value)),L.value&&(i=i.filter(t=>t.method===L.value)),U.value&&(i=i.filter(t=>t.tags.includes(U.value))),F.value=i},ke=i=>{D.value=i},De=async()=>{if(!(!n.value||!D.value))try{K.value=!0,await _.createMenuApiEndpoint(n.value.id,{menu_id:n.value.id,method:D.value.method,path:D.value.path,description:D.value.summary||void 0}),await _.loadMenuApiEndpoints(n.value.id),P.value=_.endpoints,D.value=null}catch(i){console.error("Failed to add API endpoint:",i),alert("API 엔드포인트 추가 실패: "+i.message)}finally{K.value=!1}},Ae=async i=>{if(n.value&&confirm("이 API 엔드포인트를 삭제하시겠습니까?"))try{await _.deleteMenuApiEndpoint(n.value.id,i),await _.loadMenuApiEndpoints(n.value.id),P.value=_.endpoints}catch(t){console.error("Failed to delete API endpoint:",t),alert("API 엔드포인트 삭제 실패: "+t.message)}},_e=i=>_.getMethodColor(i);return Me(()=>{$()}),(i,t)=>{var h,g;return o(),r("div",Oe,[t[28]||(t[28]=e("div",{class:"page-header"},[e("h1",null,"메뉴 관리"),e("p",{class:"subtitle"},"시스템 메뉴와 권한을 관리합니다.")],-1)),e("div",Le,[e("div",Ue,[t[10]||(t[10]=e("label",null,"검색",-1)),b(e("input",{"onUpdate:modelValue":t[0]||(t[0]=a=>S.value=a),type:"text",class:"form-control",placeholder:"메뉴명, 경로 검색",onInput:Te},null,544),[[N,S.value]])]),e("button",{onClick:t[1]||(t[1]=a=>x()),class:"btn btn-primary"},t[11]||(t[11]=[e("span",{class:"icon"},"+",-1),ae(" 새 메뉴 ",-1)])),e("button",{onClick:$,class:"btn btn-secondary"},t[12]||(t[12]=[e("span",{class:"icon"},"🔄",-1),ae(" 새로고침 ",-1)]))]),C.value?(o(),r("div",Mt,t[14]||(t[14]=[e("div",{class:"spinner"},null,-1),e("p",null,"메뉴를 불러오는 중...",-1)]))):(o(),r("div",Ve,[e("div",We,[(o(!0),r(G,null,M(ne.value,a=>{var y;return o(),r("div",{key:a.id,class:"tree-node"},[e("div",He,[e("div",Fe,[a.children&&a.children.length?(o(),r("span",{key:0,class:"expand-icon",onClick:d=>pe(a.id)},p(k.value.has(a.id)?"▼":"▶"),9,$e)):(o(),r("span",xe,"▶")),e("span",Be,p(a.icon||"📄"),1),e("span",Qe,p(a.name),1),e("span",Je,p(a.path),1),e("span",ze,"["+p(a.sort_order)+"]",1)]),e("div",je,[e("button",{onClick:d=>X(a),class:"btn-icon",title:"API 엔드포인트"}," 📡 ",8,Ke),e("button",{onClick:d=>Y(a),class:"btn-icon",title:"권한 설정"}," 🔐 ",8,qe),e("button",{onClick:d=>x(a),class:"btn-icon",title:"수정"},"✏️",8,Ye),e("button",{onClick:d=>oe(a),class:"btn-icon",title:"하위 메뉴 추가"}," ➕ ",8,Xe),(y=a.children)!=null&&y.length?A("",!0):(o(),r("button",{key:0,onClick:d=>q(a),class:"btn-icon",title:"삭제"}," 🗑️ ",8,Ze))])]),a.children&&a.children.length&&k.value.has(a.id)?(o(),r("div",et,[(o(!0),r(G,null,M(a.children,d=>{var V;return o(),r("div",{key:d.id,class:"tree-node child-node"},[e("div",tt,[e("div",at,[d.children&&d.children.length?(o(),r("span",{key:0,class:"expand-icon",onClick:v=>pe(d.id)},p(k.value.has(d.id)?"▼":"▶"),9,it)):(o(),r("span",st,"▶")),e("span",nt,p(d.icon||"📄"),1),e("span",rt,p(d.name),1),e("span",ot,p(d.path),1),e("span",pt,"["+p(d.sort_order)+"]",1)]),e("div",_t,[e("button",{onClick:v=>X(d),class:"btn-icon",title:"API 엔드포인트"}," 📡 ",8,dt),e("button",{onClick:v=>Y(d),class:"btn-icon",title:"권한 설정"}," 🔐 ",8,lt),e("button",{onClick:v=>x(d),class:"btn-icon",title:"수정"},"✏️",8,ct),e("button",{onClick:v=>oe(d),class:"btn-icon",title:"하위 메뉴 추가"}," ➕ ",8,mt),(V=d.children)!=null&&V.length?A("",!0):(o(),r("button",{key:0,onClick:v=>q(d),class:"btn-icon",title:"삭제"}," 🗑️ ",8,ut))])]),d.children&&d.children.length&&k.value.has(d.id)?(o(),r("div",ht,[(o(!0),r(G,null,M(d.children,v=>(o(),r("div",{key:v.id,class:"tree-node grandchild-node"},[e("div",gt,[e("div",vt,[t[13]||(t[13]=e("span",{class:"expand-icon",style:{visibility:"hidden"}},"▶",-1)),e("span",It,p(v.icon||"📄"),1),e("span",yt,p(v.name),1),e("span",Et,p(v.path),1),e("span",Tt,"["+p(v.sort_order)+"]",1)]),e("div",kt,[e("button",{onClick:ee=>X(v),class:"btn-icon",title:"API 엔드포인트"}," 📡 ",8,Dt),e("button",{onClick:ee=>Y(v),class:"btn-icon",title:"권한 설정"}," 🔐 ",8,At),e("button",{onClick:ee=>x(v),class:"btn-icon",title:"수정"}," ✏️ ",8,bt),e("button",{onClick:ee=>q(v),class:"btn-icon",title:"삭제"}," 🗑️ ",8,Gt)])])]))),128))])):A("",!0)])}),128))])):A("",!0)])}),128))])])),!C.value&&ne.value.length===0?(o(),r("div",ft,t[15]||(t[15]=[e("p",null,"메뉴가 없습니다.",-1)]))):A("",!0),R.value?(o(),r("div",{key:3,class:"modal-overlay",onClick:W(B,["self"])},[e("div",Pt,[e("div",wt,[e("h2",null,p(s.value.id?"메뉴 수정":"새 메뉴 추가"),1),e("button",{onClick:B,class:"close-btn"},"×")]),e("div",Nt,[e("form",{onSubmit:W(ge,["prevent"])},[e("div",Ct,[t[16]||(t[16]=e("label",null,"메뉴명 *",-1)),b(e("input",{"onUpdate:modelValue":t[2]||(t[2]=a=>s.value.name=a),type:"text",class:"form-control",required:"",placeholder:"예: 대시보드"},null,512),[[N,s.value.name]])]),e("div",St,[t[17]||(t[17]=e("label",null,"경로 *",-1)),b(e("input",{"onUpdate:modelValue":t[3]||(t[3]=a=>s.value.path=a),type:"text",class:"form-control",required:"",placeholder:"예: /dashboard"},null,512),[[N,s.value.path]])]),e("div",Rt,[t[18]||(t[18]=e("label",null,"아이콘",-1)),b(e("input",{"onUpdate:modelValue":t[4]||(t[4]=a=>s.value.icon=a),type:"text",class:"form-control",placeholder:"예: 📊"},null,512),[[N,s.value.icon]])]),e("div",Ot,[t[20]||(t[20]=e("label",null,"부모 메뉴",-1)),b(e("select",{"onUpdate:modelValue":t[5]||(t[5]=a=>s.value.parent_id=a),class:"form-control"},[t[19]||(t[19]=e("option",{value:null},"없음 (최상위 메뉴)",-1)),(o(!0),r(G,null,M(he.value,a=>(o(),r("option",{key:a.id,value:a.id},p(a.name)+" "+p(a.parent_name?`(${a.parent_name})`:""),9,Lt))),128))],512),[[ie,s.value.parent_id]])]),e("div",Ut,[t[21]||(t[21]=e("label",null,"정렬 순서",-1)),b(e("input",{"onUpdate:modelValue":t[6]||(t[6]=a=>s.value.sort_order=a),type:"number",class:"form-control",placeholder:"999"},null,512),[[N,s.value.sort_order,void 0,{number:!0}]])]),e("div",Vt,[e("button",{type:"submit",class:"btn btn-primary",disabled:T.value},p(T.value?"저장 중...":"저장"),9,Wt),e("button",{type:"button",onClick:B,class:"btn btn-secondary"},"취소")])],32)])])])):A("",!0),m.value?(o(),r("div",{key:4,class:"modal-overlay",onClick:W(Q,["self"])},[e("div",Ht,[e("div",Ft,[e("h2",null,"권한 설정: "+p((h=n.value)==null?void 0:h.name),1),e("button",{onClick:Q,class:"close-btn"},"×")]),e("div",$t,[e("div",xt,[(o(),r(G,null,M(ce,a=>{var y;return e("div",{key:a,class:"permission-item"},[e("label",null,[e("input",{type:"checkbox",checked:ve((y=n.value)==null?void 0:y.id,a),onChange:d=>{var V;return Ie((V=n.value)==null?void 0:V.id,a)}},null,40,Bt),ae(" "+p(Ee(a)),1)])])}),64))]),e("div",Qt,[e("button",{onClick:ye,class:"btn btn-primary",disabled:T.value},p(T.value?"저장 중...":"권한 저장"),9,Jt),e("button",{onClick:Q,class:"btn btn-secondary"},"닫기")])])])])):A("",!0),w.value?(o(),r("div",{key:5,class:"modal-overlay",onClick:W(Z,["self"])},[e("div",zt,[e("div",jt,[e("h2",null,"API 엔드포인트: "+p((g=n.value)==null?void 0:g.name),1),e("button",{onClick:Z,class:"close-btn"},"×")]),e("div",Kt,[e("div",qt,[t[27]||(t[27]=e("h3",null,"새 엔드포인트 추가",-1)),e("div",Yt,[e("div",Xt,[t[22]||(t[22]=e("label",null,"검색",-1)),b(e("input",{"onUpdate:modelValue":t[7]||(t[7]=a=>O.value=a),type:"text",class:"form-control",placeholder:"경로, 설명, 태그 검색...",onInput:J},null,544),[[N,O.value]])]),e("div",Zt,[t[24]||(t[24]=e("label",null,"메소드",-1)),b(e("select",{"onUpdate:modelValue":t[8]||(t[8]=a=>L.value=a),class:"form-control",onChange:J},[t[23]||(t[23]=e("option",{value:""},"전체",-1)),(o(),r(G,null,M(me,a=>e("option",{key:a,value:a},p(a),9,ea)),64))],544),[[ie,L.value]])]),e("div",ta,[t[26]||(t[26]=e("label",null,"태그",-1)),b(e("select",{"onUpdate:modelValue":t[9]||(t[9]=a=>U.value=a),class:"form-control",onChange:J},[t[25]||(t[25]=e("option",{value:""},"전체",-1)),(o(!0),r(G,null,M(ue.value,a=>(o(),r("option",{key:a,value:a},p(a),9,aa))),128))],544),[[ie,U.value]])])]),e("div",ia,[e("div",sa," 사용 가능한 엔드포인트: "+p(F.value.length)+"개 ",1),e("div",na,[(o(!0),r(G,null,M(F.value,a=>(o(),r("div",{key:`${a.method}-${a.path}`,class:fe(["available-endpoint-item",{selected:D.value===a}]),onClick:y=>ke(a)},[e("span",{class:"method-badge",style:de({background:_e(a.method)})},p(a.method),5),e("div",oa,[e("div",pa,p(a.path),1),e("div",_a,p(a.summary),1)]),D.value===a?(o(),r("button",{key:0,type:"button",onClick:W(De,["stop"]),class:"btn btn-sm btn-primary",disabled:K.value}," 추가 ",8,da)):A("",!0)],10,ra))),128))])])]),e("div",la,[e("h3",null,"등록된 엔드포인트 ("+p(P.value.length)+"개)",1),P.value.length===0?(o(),r("div",ca," 등록된 API 엔드포인트가 없습니다. ")):(o(),r("div",ma,[(o(!0),r(G,null,M(P.value,a=>(o(),r("div",{key:a.id,class:"endpoint-item"},[e("div",ua,[e("span",{class:"method-badge",style:de({background:_e(a.method)})},p(a.method),5),e("span",ha,p(a.path),1),e("span",ga,p(a.description),1)]),e("button",{onClick:y=>Ae(a.id),class:"btn-icon",title:"삭제"}," 🗑️ ",8,va)]))),128))]))]),e("div",{class:"form-actions"},[e("button",{onClick:Z,class:"btn btn-secondary"},"닫기")])])])])):A("",!0)])}}}),Da=Pe(Ia,[["__scopeId","data-v-48f8b855"]]);export{Da as default};
