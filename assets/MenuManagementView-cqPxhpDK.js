import{B as we,l as m,d as Ce,c as ie,J as Ne,a as r,t as e,x as E,D as b,E as N,z as he,F as G,f as M,C as H,v as _,H as ne,u as Se,N as ge,o}from"./vendor-C2HvWOl7.js";import{j as ve,_ as Re}from"./index-O4ZtvAgN.js";import{b as Oe}from"./menus-api-io4VfvZj.js";import{b as Le}from"./menu-api-endpoints-api-eJrdRblN.js";const Ue=we("menuApiEndpoints",()=>{const T=m([]),c=m(!1),d=m(null),y=new Le(ve()),f=async i=>{try{c.value=!0,d.value=null,console.log("📡 Loading menu API endpoints for menu:",i);const u=await y.getMenuApiEndpointsApiMenusMenuIdApiEndpointsGet(i);u.data?(T.value=Array.isArray(u.data)?u.data:[u.data],console.log("✅ Loaded menu API endpoints:",T.value)):T.value=[]}catch(u){console.error("❌ Failed to load menu API endpoints:",u),d.value=`메뉴 API 엔드포인트 조회 실패: ${u.message}`,T.value=[]}finally{c.value=!1}};return{endpoints:T,loading:c,error:d,loadMenuApiEndpoints:f,searchMenuApiEndpoints:async(i,u,n)=>{try{c.value=!0,d.value=null,console.log("📡 Searching menu API endpoints:",{path:i,method:u,menuId:n});const h=await y.searchMenuApiEndpointsApiMenusApiEndpointsSearchGet(i,u,n);if(h.data){const w=Array.isArray(h.data)?h.data:[h.data];return console.log("✅ Found menu API endpoints:",w),w}return[]}catch(h){return console.error("❌ Failed to search menu API endpoints:",h),d.value=`메뉴 API 엔드포인트 검색 실패: ${h.message}`,[]}finally{c.value=!1}},createMenuApiEndpoint:async(i,u)=>{try{c.value=!0,d.value=null,console.log("📡 Creating menu API endpoint:",i,u);const n=await y.createMenuApiEndpointApiMenusMenuIdApiEndpointsPost(i,u);return console.log("✅ Created menu API endpoint:",n.data),await f(i),n.data}catch(n){throw console.error("❌ Failed to create menu API endpoint:",n),d.value=`메뉴 API 엔드포인트 생성 실패: ${n.message}`,n}finally{c.value=!1}},updateMenuApiEndpoint:async(i,u,n)=>{try{c.value=!0,d.value=null,console.log("📡 Updating menu API endpoint:",i,u,n);const h=await y.updateMenuApiEndpointApiMenusMenuIdApiEndpointsEndpointIdPut(i,u,n);return console.log("✅ Updated menu API endpoint:",h.data),await f(i),h.data}catch(h){throw console.error("❌ Failed to update menu API endpoint:",h),d.value=`메뉴 API 엔드포인트 수정 실패: ${h.message}`,h}finally{c.value=!1}},deleteMenuApiEndpoint:async(i,u)=>{try{c.value=!0,d.value=null,console.log("📡 Deleting menu API endpoint:",i,u),await y.deleteMenuApiEndpointApiMenusMenuIdApiEndpointsEndpointIdDelete(i,u),console.log("✅ Deleted menu API endpoint"),await f(i)}catch(n){throw console.error("❌ Failed to delete menu API endpoint:",n),d.value=`메뉴 API 엔드포인트 삭제 실패: ${n.message}`,n}finally{c.value=!1}},httpMethods:["GET","POST","PUT","DELETE","PATCH"],getMethodColor:i=>({GET:"#10b981",POST:"#3b82f6",PUT:"#f59e0b",DELETE:"#ef4444",PATCH:"#8b5cf6"})[i]||"#6b7280",hasWildcard:i=>i.includes("*")}}),re=[{path:"/api/auth/token",method:"POST",summary:"사용자 로그인 및 토큰 발급",description:"운전자앱/관리자가 로그인하여 JWT 토큰을 발급받습니다",operationId:"login_for_access_token_api_auth_token_post",tags:["auth"]},{path:"/api/auth/login",method:"POST",summary:"사용자 로그인 (별칭)",description:"토큰 엔드포인트의 별칭 - 일반적인 REST API 패턴 지원",operationId:"login_alias_api_auth_login_post",tags:["auth"]},{path:"/api/auth/logout",method:"POST",summary:"로그아웃",description:"로그아웃 이벤트를 기록합니다",operationId:"logout_api_auth_logout_post",tags:["auth"]},{path:"/api/auth/my-permissions",method:"GET",summary:"현재 사용자의 메뉴 권한 조회",description:"현재 로그인한 사용자의 메뉴별 CRUD 권한을 조회합니다 (프론트엔드 버튼 제어용)",operationId:"get_my_permissions_api_auth_my_permissions_get",tags:["auth"]},{path:"/api/users",method:"POST",summary:"Create User",description:"",operationId:"create_user_api_users_post",tags:["users"]},{path:"/api/users",method:"GET",summary:"Get Users",description:`사용자 목록 조회
...
**필요한 권한:** DRIVER, ADMIN`,operationId:"get_screen_config_api_driver_app_screens__screen_type__get",tags:["driver-app"]},{path:"/api/driver-app/events",method:"POST",summary:"Send Event",description:`이벤트/긴급 전송 - Issue #131 설계 준수
...
**필요한 권한:** DRIVER, ADMIN`,operationId:"mark_call_seats_no_show_api_driver_app_calls__call_id__seats_no_show_post",tags:["driver-app"]},{path:"/api/pvd/message",method:"POST",summary:"PVD 통합 메시지 수신",description:`최적화된 PVD 메시지 처리
- 명시적 세션 관리로 연결 풀 보호
- DB 작업 최소화
...
Returns:
    현재 연결 상태 정보`,operationId:"get_websocket_status_api_websocket_status_get",tags:["websocket"]},{path:"/api/health",method:"GET",summary:"Health Check",description:"시스템 상태 및 DB 연결 풀 상태 확인",operationId:"health_check_api_health_get",tags:["monitoring"]},{path:"/",method:"GET",summary:"프론트엔드 리다이렉트",description:"루트 경로 접속 시 정적 HTML 페이지로 리다이렉트",operationId:"read_root__get",tags:["system"]},{path:"/api/version",method:"GET",summary:"시스템 버전 정보",description:"현재 배포된 시스템의 Git 커밋 정보 조회",operationId:"get_version_api_version_get",tags:["system"]}];function Ve(){return re}function We(T){if(!T)return re;const c=T.toLowerCase();return re.filter(d=>d.path.toLowerCase().includes(c)||d.method.toLowerCase().includes(c)||d.summary.toLowerCase().includes(c)||d.description.toLowerCase().includes(c)||d.operationId.toLowerCase().includes(c)||d.tags.some(y=>y.toLowerCase().includes(c)))}const He={class:"menu-management"},Fe={class:"filters-section"},$e={class:"filter-group"},xe={key:0,class:"menu-tree"},Be={class:"tree-container"},Qe={class:"node-content"},Je={class:"node-info"},ze=["onClick"],Ke={key:1,class:"expand-icon",style:{visibility:"hidden"}},je={class:"menu-icon"},qe={class:"menu-name"},Ye={class:"menu-path"},Xe={class:"menu-order"},Ze={key:2,class:"api-count-badge"},et={class:"node-actions"},tt=["onClick"],at=["onClick"],st=["onClick"],it=["onClick"],nt=["onClick"],rt={key:0,class:"tree-children"},ot={class:"node-content"},pt={class:"node-info"},_t=["onClick"],dt={key:1,class:"expand-icon",style:{visibility:"hidden"}},lt={class:"menu-icon"},ct={class:"menu-name"},mt={class:"menu-path"},ut={class:"menu-order"},ht={key:2,class:"api-count-badge"},gt={class:"node-actions"},vt=["onClick"],It=["onClick"],yt=["onClick"],Et=["onClick"],Tt=["onClick"],kt={key:0,class:"tree-children"},Dt={class:"node-content"},At={class:"node-info"},bt={class:"menu-icon"},Gt={class:"menu-name"},Mt={class:"menu-path"},ft={class:"menu-order"},Pt={key:0,class:"api-count-badge"},wt={class:"node-actions"},Ct=["onClick"],Nt=["onClick"],St=["onClick"],Rt=["onClick"],Ot={key:1,class:"loading-container"},Lt={key:2,class:"empty-state"},Ut={class:"modal-content"},Vt={class:"modal-header"},Wt={class:"modal-body"},Ht={class:"form-group"},Ft={class:"form-group"},$t={class:"form-group"},xt={class:"form-group"},Bt=["value"],Qt={class:"form-group"},Jt={class:"form-actions"},zt=["disabled"],Kt={class:"modal-content modal-wide"},jt={class:"modal-header"},qt={class:"modal-body"},Yt={class:"permission-table-container"},Xt={class:"permission-table"},Zt={class:"role-name"},ea={class:"permission-cell"},ta=["checked","onChange"],aa={class:"permission-cell"},sa=["checked","onChange"],ia={class:"permission-cell"},na=["checked","onChange"],ra={class:"permission-cell"},oa=["checked","onChange"],pa={class:"permission-cell"},_a=["checked","onChange"],da={class:"form-actions"},la=["disabled"],ca={class:"modal-content modal-large"},ma={class:"modal-header"},ua={class:"modal-body"},ha={class:"endpoint-form"},ga={class:"endpoint-filters"},va={class:"form-group"},Ia={class:"form-group"},ya=["value"],Ea={class:"form-group"},Ta=["value"],ka={class:"available-endpoints-list"},Da={class:"available-endpoints-count"},Aa={class:"available-endpoints-scroll"},ba=["onClick"],Ga={class:"endpoint-detail"},Ma={class:"endpoint-path"},fa={class:"endpoint-summary"},Pa=["disabled"],wa={class:"endpoints-list"},Ca={key:0,class:"empty-message"},Na={key:1,class:"endpoint-items"},Sa={class:"endpoint-info"},Ra={class:"endpoint-path"},Oa={class:"endpoint-desc"},La=["onClick"],Ua=Ce({__name:"MenuManagementView",setup(T){const c=new Oe(ve()),d=Ue(),y=m([]),f=m([]),S=m(!1),k=m(!1),q=m(null),R=m(""),D=m(new Set),Y=m(),O=m(!1),i=m({name:"",path:"",icon:"",parent_id:null,sort_order:999}),u=m(!1),n=m(null),h=m(new Map),w=m(!1),P=m([]),X=m(!1),F=m([]),$=m([]),L=m(""),A=m(null),U=m(""),V=m(""),W=m(new Map),oe=["ADMIN","MANAGER","OPERATOR","DRIVER","VIEWER"],Ie=["GET","POST","PUT","DELETE","PATCH"],ye=ie(()=>{const s=new Set;return F.value.forEach(t=>{t.tags.forEach(p=>s.add(p))}),Array.from(s).sort()}),pe=ie(()=>{const s=y.value.filter(g=>{var a;if(R.value){const v=R.value.toLowerCase();if(!g.name.toLowerCase().includes(v)&&!((a=g.path)!=null&&a.toLowerCase().includes(v)))return!1}return!0}),t=s.filter(g=>!g.parent_id),p=g=>s.filter(a=>a.parent_id===g).map(a=>({...a,children:p(a.id)})).sort((a,v)=>(a.sort_order||999)-(v.sort_order||999));return t.map(g=>({...g,children:p(g.id)})).sort((g,a)=>(g.sort_order||999)-(a.sort_order||999))}),Ee=ie(()=>y.value.filter(s=>{let t=0,p=s;for(;p.parent_id&&t<2;)p=y.value.find(g=>g.id===p.parent_id)||p,t++;return t<2}).map(s=>{const t=s.parent_id?y.value.find(p=>p.id===s.parent_id):null;return{...s,parent_name:t==null?void 0:t.name}})),x=async()=>{try{S.value=!0,q.value=null;const s=await c.getMenusApiMenusGet();if(s.data){const t=Array.isArray(s.data)?s.data:s.data.items||[];y.value=t,t.filter(p=>!p.parent_id).forEach(p=>D.value.add(p.id))}await _e()}catch(s){console.error("Failed to load menus:",s),q.value=s.message}finally{S.value=!1}},_e=async()=>{try{const s=[];for(const t of oe)try{const p=await c.getRoleMenuPermissionsApiMenusPermissionsRoleGet(t);if(p.data&&p.data.menus){const g=p.data.menus.filter(a=>a.id!==void 0).map(a=>({role:p.data.role,menu_id:a.id,can_read:a.can_read??!1,can_create:a.can_create??!1,can_update:a.can_update??!1,can_delete:a.can_delete??!1}));s.push(...g)}}catch{}s.length>0&&(f.value=s)}catch(s){console.error("Failed to load permissions:",s)}},B=s=>{s?i.value={id:s.id,name:s.name,path:s.path,icon:s.icon,parent_id:s.parent_id,sort_order:s.sort_order}:i.value={name:"",path:"",icon:"",parent_id:null,sort_order:999},O.value=!0},de=s=>{i.value={name:"",path:s.path+"/",icon:"",parent_id:s.id,sort_order:999},O.value=!0},Q=()=>{O.value=!1,i.value={}},Te=async()=>{try{k.value=!0,i.value.id?await c.updateMenuApiMenusMenuIdPut(i.value.id,i.value):await c.createMenuApiMenusPost(i.value),Q(),await x()}catch(s){console.error("Failed to save menu:",s),alert("메뉴 저장 실패: "+s.message)}finally{k.value=!1}},Z=async s=>{if(confirm(`"${s.name}" 메뉴를 삭제하시겠습니까?`))try{await c.deleteMenuApiMenusMenuIdDelete(s.id),await x()}catch(t){console.error("Failed to delete menu:",t),alert("메뉴 삭제 실패: "+t.message)}},le=s=>{D.value.has(s)?D.value.delete(s):D.value.add(s)},ee=s=>{n.value=s,h.value.clear(),f.value.filter(t=>t.menu_id===s.id&&t.role).forEach(t=>{t.role&&h.value.set(t.role,{can_read:t.can_read||!1,can_create:t.can_create||!1,can_update:t.can_update||!1,can_delete:t.can_delete||!1})}),u.value=!0},J=()=>{u.value=!1,n.value=null,h.value.clear()},z=(s,t)=>{const p=h.value.get(s);return p?p[t]:!1},K=(s,t)=>{const p=h.value.get(s)||{can_read:!1,can_create:!1,can_update:!1,can_delete:!1};p[t]=!p[t],h.value.set(s,{...p})},ce=s=>{const t=h.value.get(s);return t?t.can_read&&t.can_create&&t.can_update&&t.can_delete:!1},ke=s=>{const t=ce(s);h.value.set(s,{can_read:!t,can_create:!t,can_update:!t,can_delete:!t})},De=async()=>{var s;if(n.value)try{k.value=!0;for(const[t,p]of h.value.entries()){const g=p.can_read||p.can_create||p.can_update||p.can_delete;try{let v=(await c.getRoleMenuPermissionsApiMenusPermissionsRoleGet(t)).data.menu_ids||[];g?v.includes(n.value.id)||v.push(n.value.id):v=v.filter(l=>l!==n.value.id),v.length>0?await c.updateRoleMenuPermissionsApiMenusPermissionsRolePut(t,{role:t,menu_ids:v}):await c.deleteRoleMenuPermissionsApiMenusPermissionsRoleDelete(t)}catch(a){if(((s=a.response)==null?void 0:s.status)===404)g&&await c.setRoleMenuPermissionsApiMenusPermissionsPost({role:t,menu_ids:[n.value.id]});else throw a}}await _e(),J()}catch(t){console.error("Failed to save permissions:",t),alert("권한 저장 실패: "+t.message)}finally{k.value=!1}},Ae=s=>({ADMIN:"관리자",MANAGER:"매니저",OPERATOR:"운영자",DRIVER:"운전자",VIEWER:"조회자"})[s]||s,be=()=>{clearTimeout(Y.value),Y.value=setTimeout(()=>{},300)},te=async s=>{n.value=s,w.value=!0,await d.loadMenuApiEndpoints(s.id),P.value=d.endpoints,F.value=Ve(),L.value="",U.value="",V.value="",A.value=null,j()},ae=()=>{w.value=!1,n.value=null,P.value=[],F.value=[],$.value=[]},j=()=>{let s=F.value;L.value&&(s=We(L.value)),U.value&&(s=s.filter(t=>t.method===U.value)),V.value&&(s=s.filter(t=>t.tags.includes(V.value))),$.value=s},Ge=s=>{A.value=s},Me=async()=>{if(!(!n.value||!A.value))try{X.value=!0,await d.createMenuApiEndpoint(n.value.id,{menu_id:n.value.id,method:A.value.method,path:A.value.path,description:A.value.summary||void 0}),await d.loadMenuApiEndpoints(n.value.id),P.value=d.endpoints,W.value.set(n.value.id,d.endpoints.length),A.value=null}catch(s){console.error("Failed to add API endpoint:",s),alert("API 엔드포인트 추가 실패: "+s.message)}finally{X.value=!1}},fe=async s=>{if(n.value&&confirm("이 API 엔드포인트를 삭제하시겠습니까?"))try{await d.deleteMenuApiEndpoint(n.value.id,s),await d.loadMenuApiEndpoints(n.value.id),P.value=d.endpoints,W.value.set(n.value.id,d.endpoints.length)}catch(t){console.error("Failed to delete API endpoint:",t),alert("API 엔드포인트 삭제 실패: "+t.message)}},me=s=>d.getMethodColor(s),C=s=>W.value.get(s)||0,Pe=async()=>{try{for(const s of y.value)try{await d.loadMenuApiEndpoints(s.id),W.value.set(s.id,d.endpoints.length)}catch{W.value.set(s.id,0)}}catch(s){console.error("Failed to load menu API counts:",s)}};return Ne(async()=>{await x(),await Pe()}),(s,t)=>{var p,g;return o(),r("div",He,[t[29]||(t[29]=e("div",{class:"page-header"},[e("h1",null,"메뉴 관리"),e("p",{class:"subtitle"},"시스템 메뉴와 권한을 관리합니다.")],-1)),e("div",Fe,[e("div",$e,[t[10]||(t[10]=e("label",null,"검색",-1)),b(e("input",{"onUpdate:modelValue":t[0]||(t[0]=a=>R.value=a),type:"text",class:"form-control",placeholder:"메뉴명, 경로 검색",onInput:be},null,544),[[N,R.value]])]),e("button",{onClick:t[1]||(t[1]=a=>B()),class:"btn btn-primary"},t[11]||(t[11]=[e("span",{class:"icon"},"+",-1),he(" 새 메뉴 ",-1)])),e("button",{onClick:x,class:"btn btn-secondary"},t[12]||(t[12]=[e("span",{class:"icon"},"🔄",-1),he(" 새로고침 ",-1)]))]),S.value?(o(),r("div",Ot,t[14]||(t[14]=[e("div",{class:"spinner"},null,-1),e("p",null,"메뉴를 불러오는 중...",-1)]))):(o(),r("div",xe,[e("div",Be,[(o(!0),r(G,null,M(pe.value,a=>{var v;return o(),r("div",{key:a.id,class:"tree-node"},[e("div",Qe,[e("div",Je,[a.children&&a.children.length?(o(),r("span",{key:0,class:"expand-icon",onClick:l=>le(a.id)},_(D.value.has(a.id)?"▼":"▶"),9,ze)):(o(),r("span",Ke,"▶")),e("span",je,_(a.icon||"📄"),1),e("span",qe,_(a.name),1),e("span",Ye,_(a.path),1),e("span",Xe,"["+_(a.sort_order)+"]",1),C(a.id)>0?(o(),r("span",Ze," API: "+_(C(a.id)),1)):E("",!0)]),e("div",et,[e("button",{onClick:l=>te(a),class:"btn-icon",title:"API 엔드포인트"}," 📡 ",8,tt),e("button",{onClick:l=>ee(a),class:"btn-icon",title:"권한 설정"}," 🔐 ",8,at),e("button",{onClick:l=>B(a),class:"btn-icon",title:"수정"},"✏️",8,st),e("button",{onClick:l=>de(a),class:"btn-icon",title:"하위 메뉴 추가"}," ➕ ",8,it),(v=a.children)!=null&&v.length?E("",!0):(o(),r("button",{key:0,onClick:l=>Z(a),class:"btn-icon",title:"삭제"}," 🗑️ ",8,nt))])]),a.children&&a.children.length&&D.value.has(a.id)?(o(),r("div",rt,[(o(!0),r(G,null,M(a.children,l=>{var ue;return o(),r("div",{key:l.id,class:"tree-node child-node"},[e("div",ot,[e("div",pt,[l.children&&l.children.length?(o(),r("span",{key:0,class:"expand-icon",onClick:I=>le(l.id)},_(D.value.has(l.id)?"▼":"▶"),9,_t)):(o(),r("span",dt,"▶")),e("span",lt,_(l.icon||"📄"),1),e("span",ct,_(l.name),1),e("span",mt,_(l.path),1),e("span",ut,"["+_(l.sort_order)+"]",1),C(l.id)>0?(o(),r("span",ht," API: "+_(C(l.id)),1)):E("",!0)]),e("div",gt,[e("button",{onClick:I=>te(l),class:"btn-icon",title:"API 엔드포인트"}," 📡 ",8,vt),e("button",{onClick:I=>ee(l),class:"btn-icon",title:"권한 설정"}," 🔐 ",8,It),e("button",{onClick:I=>B(l),class:"btn-icon",title:"수정"},"✏️",8,yt),e("button",{onClick:I=>de(l),class:"btn-icon",title:"하위 메뉴 추가"}," ➕ ",8,Et),(ue=l.children)!=null&&ue.length?E("",!0):(o(),r("button",{key:0,onClick:I=>Z(l),class:"btn-icon",title:"삭제"}," 🗑️ ",8,Tt))])]),l.children&&l.children.length&&D.value.has(l.id)?(o(),r("div",kt,[(o(!0),r(G,null,M(l.children,I=>(o(),r("div",{key:I.id,class:"tree-node grandchild-node"},[e("div",Dt,[e("div",At,[t[13]||(t[13]=e("span",{class:"expand-icon",style:{visibility:"hidden"}},"▶",-1)),e("span",bt,_(I.icon||"📄"),1),e("span",Gt,_(I.name),1),e("span",Mt,_(I.path),1),e("span",ft,"["+_(I.sort_order)+"]",1),C(I.id)>0?(o(),r("span",Pt," API: "+_(C(I.id)),1)):E("",!0)]),e("div",wt,[e("button",{onClick:se=>te(I),class:"btn-icon",title:"API 엔드포인트"}," 📡 ",8,Ct),e("button",{onClick:se=>ee(I),class:"btn-icon",title:"권한 설정"}," 🔐 ",8,Nt),e("button",{onClick:se=>B(I),class:"btn-icon",title:"수정"}," ✏️ ",8,St),e("button",{onClick:se=>Z(I),class:"btn-icon",title:"삭제"}," 🗑️ ",8,Rt)])])]))),128))])):E("",!0)])}),128))])):E("",!0)])}),128))])])),!S.value&&pe.value.length===0?(o(),r("div",Lt,t[15]||(t[15]=[e("p",null,"메뉴가 없습니다.",-1)]))):E("",!0),O.value?(o(),r("div",{key:3,class:"modal-overlay",onClick:H(Q,["self"])},[e("div",Ut,[e("div",Vt,[e("h2",null,_(i.value.id?"메뉴 수정":"새 메뉴 추가"),1),e("button",{onClick:Q,class:"close-btn"},"×")]),e("div",Wt,[e("form",{onSubmit:H(Te,["prevent"])},[e("div",Ht,[t[16]||(t[16]=e("label",null,"메뉴명 *",-1)),b(e("input",{"onUpdate:modelValue":t[2]||(t[2]=a=>i.value.name=a),type:"text",class:"form-control",required:"",placeholder:"예: 대시보드"},null,512),[[N,i.value.name]])]),e("div",Ft,[t[17]||(t[17]=e("label",null,"경로 *",-1)),b(e("input",{"onUpdate:modelValue":t[3]||(t[3]=a=>i.value.path=a),type:"text",class:"form-control",required:"",placeholder:"예: /dashboard"},null,512),[[N,i.value.path]])]),e("div",$t,[t[18]||(t[18]=e("label",null,"아이콘",-1)),b(e("input",{"onUpdate:modelValue":t[4]||(t[4]=a=>i.value.icon=a),type:"text",class:"form-control",placeholder:"예: 📊"},null,512),[[N,i.value.icon]])]),e("div",xt,[t[20]||(t[20]=e("label",null,"부모 메뉴",-1)),b(e("select",{"onUpdate:modelValue":t[5]||(t[5]=a=>i.value.parent_id=a),class:"form-control"},[t[19]||(t[19]=e("option",{value:null},"없음 (최상위 메뉴)",-1)),(o(!0),r(G,null,M(Ee.value,a=>(o(),r("option",{key:a.id,value:a.id},_(a.name)+" "+_(a.parent_name?`(${a.parent_name})`:""),9,Bt))),128))],512),[[ne,i.value.parent_id]])]),e("div",Qt,[t[21]||(t[21]=e("label",null,"정렬 순서",-1)),b(e("input",{"onUpdate:modelValue":t[6]||(t[6]=a=>i.value.sort_order=a),type:"number",class:"form-control",placeholder:"999"},null,512),[[N,i.value.sort_order,void 0,{number:!0}]])]),e("div",Jt,[e("button",{type:"submit",class:"btn btn-primary",disabled:k.value},_(k.value?"저장 중...":"저장"),9,zt),e("button",{type:"button",onClick:Q,class:"btn btn-secondary"},"취소")])],32)])])])):E("",!0),u.value?(o(),r("div",{key:4,class:"modal-overlay",onClick:H(J,["self"])},[e("div",Kt,[e("div",jt,[e("h2",null,"권한 설정: "+_((p=n.value)==null?void 0:p.name),1),e("button",{onClick:J,class:"close-btn"},"×")]),e("div",qt,[e("div",Yt,[e("table",Xt,[t[22]||(t[22]=e("thead",null,[e("tr",null,[e("th",null,"역할"),e("th",null,"조회 (GET)"),e("th",null,"생성 (POST)"),e("th",null,"수정 (PUT/PATCH)"),e("th",null,"삭제 (DELETE)"),e("th",null,"전체")])],-1)),e("tbody",null,[(o(),r(G,null,M(oe,a=>e("tr",{key:a},[e("td",Zt,_(Ae(a)),1),e("td",ea,[e("input",{type:"checkbox",checked:z(a,"can_read"),onChange:v=>K(a,"can_read")},null,40,ta)]),e("td",aa,[e("input",{type:"checkbox",checked:z(a,"can_create"),onChange:v=>K(a,"can_create")},null,40,sa)]),e("td",ia,[e("input",{type:"checkbox",checked:z(a,"can_update"),onChange:v=>K(a,"can_update")},null,40,na)]),e("td",ra,[e("input",{type:"checkbox",checked:z(a,"can_delete"),onChange:v=>K(a,"can_delete")},null,40,oa)]),e("td",pa,[e("input",{type:"checkbox",checked:ce(a),onChange:v=>ke(a)},null,40,_a)])])),64))])])]),e("div",da,[e("button",{onClick:De,class:"btn btn-primary",disabled:k.value},_(k.value?"저장 중...":"권한 저장"),9,la),e("button",{onClick:J,class:"btn btn-secondary"},"닫기")])])])])):E("",!0),w.value?(o(),r("div",{key:5,class:"modal-overlay",onClick:H(ae,["self"])},[e("div",ca,[e("div",ma,[e("h2",null,"API 엔드포인트: "+_((g=n.value)==null?void 0:g.name),1),e("button",{onClick:ae,class:"close-btn"},"×")]),e("div",ua,[e("div",ha,[t[28]||(t[28]=e("h3",null,"새 엔드포인트 추가",-1)),e("div",ga,[e("div",va,[t[23]||(t[23]=e("label",null,"검색",-1)),b(e("input",{"onUpdate:modelValue":t[7]||(t[7]=a=>L.value=a),type:"text",class:"form-control",placeholder:"경로, 설명, 태그 검색...",onInput:j},null,544),[[N,L.value]])]),e("div",Ia,[t[25]||(t[25]=e("label",null,"메소드",-1)),b(e("select",{"onUpdate:modelValue":t[8]||(t[8]=a=>U.value=a),class:"form-control",onChange:j},[t[24]||(t[24]=e("option",{value:""},"전체",-1)),(o(),r(G,null,M(Ie,a=>e("option",{key:a,value:a},_(a),9,ya)),64))],544),[[ne,U.value]])]),e("div",Ea,[t[27]||(t[27]=e("label",null,"태그",-1)),b(e("select",{"onUpdate:modelValue":t[9]||(t[9]=a=>V.value=a),class:"form-control",onChange:j},[t[26]||(t[26]=e("option",{value:""},"전체",-1)),(o(!0),r(G,null,M(ye.value,a=>(o(),r("option",{key:a,value:a},_(a),9,Ta))),128))],544),[[ne,V.value]])])]),e("div",ka,[e("div",Da," 사용 가능한 엔드포인트: "+_($.value.length)+"개 ",1),e("div",Aa,[(o(!0),r(G,null,M($.value,a=>(o(),r("div",{key:`${a.method}-${a.path}`,class:Se(["available-endpoint-item",{selected:A.value===a}]),onClick:v=>Ge(a)},[e("span",{class:"method-badge",style:ge({background:me(a.method)})},_(a.method),5),e("div",Ga,[e("div",Ma,_(a.path),1),e("div",fa,_(a.summary),1)]),A.value===a?(o(),r("button",{key:0,type:"button",onClick:H(Me,["stop"]),class:"btn btn-sm btn-primary",disabled:X.value}," 추가 ",8,Pa)):E("",!0)],10,ba))),128))])])]),e("div",wa,[e("h3",null,"등록된 엔드포인트 ("+_(P.value.length)+"개)",1),P.value.length===0?(o(),r("div",Ca," 등록된 API 엔드포인트가 없습니다. ")):(o(),r("div",Na,[(o(!0),r(G,null,M(P.value,a=>(o(),r("div",{key:a.id,class:"endpoint-item"},[e("div",Sa,[e("span",{class:"method-badge",style:ge({background:me(a.method)})},_(a.method),5),e("span",Ra,_(a.path),1),e("span",Oa,_(a.description),1)]),e("button",{onClick:v=>fe(a.id),class:"btn-icon",title:"삭제"}," 🗑️ ",8,La)]))),128))]))]),e("div",{class:"form-actions"},[e("button",{onClick:ae,class:"btn btn-secondary"},"닫기")])])])])):E("",!0)])}}}),$a=Re(Ua,[["__scopeId","data-v-be351f5b"]]);export{$a as default};
