...
Returns:
    현재 연결 상태 정보`,operationId:"get_websocket_status_api_websocket_status_get",tags:["websocket"]},{path:"/api/health",method:"GET",summary:"Health Check",description:"시스템 상태 및 DB 연결 풀 상태 확인",operationId:"health_check_api_health_get",tags:["monitoring"]},{path:"/",method:"GET",summary:"프론트엔드 리다이렉트",description:"루트 경로 접속 시 정적 HTML 페이지로 리다이렉트",operationId:"read_root__get",tags:["system"]},{path:"/api/version",method:"GET",summary:"시스템 버전 정보",description:"현재 배포된 시스템의 Git 커밋 정보 조회",operationId:"get_version_api_version_get",tags:["system"]}];function Ve(){return oe}function Fe(T){if(!T)return oe;const c=T.toLowerCase();return oe.filter(d=>d.path.toLowerCase().includes(c)||d.method.toLowerCase().includes(c)||d.summary.toLowerCase().includes(c)||d.description.toLowerCase().includes(c)||d.operationId.toLowerCase().includes(c)||d.tags.some(I=>I.toLowerCase().includes(c)))}const We={class:"menu-management"},He={class:"filters-section"},$e={class:"filter-group"},xe={key:0,class:"menu-tree"},Be={class:"tree-container"},Qe={class:"node-content"},Ke={class:"node-info"},Je=["onClick"],je={key:1,class:"expand-icon",style:{visibility:"hidden"}},qe={class:"menu-icon"},ze={class:"menu-name"},Ye={class:"menu-path"},Xe={class:"menu-order"},Ze={key:2,class:"api-count-badge"},et={class:"node-actions"},tt=["onClick"],at=["onClick"],st=["onClick"],it=["onClick"],nt=["onClick"],ot={key:0,class:"tree-children"},rt={class:"node-content"},_t={class:"node-info"},pt=["onClick"],dt={key:1,class:"expand-icon",style:{visibility:"hidden"}},lt={class:"menu-icon"},ct={class:"menu-name"},mt={class:"menu-path"},ut={class:"menu-order"},ht={key:2,class:"api-count-badge"},gt={class:"node-actions"},vt=["onClick"],yt=["onClick"],It=["onClick"],Et=["onClick"],Tt=["onClick"],kt={key:0,class:"tree-children"},Dt={class:"node-content"},At={class:"node-info"},ft={class:"menu-icon"},bt={class:"menu-name"},Mt={class:"menu-path"},Gt={class:"menu-order"},Pt={key:0,class:"api-count-badge"},Nt={class:"node-actions"},wt=["onClick"],Ct=["onClick"],St=["onClick"],Rt=["onClick"],Ot={key:1,class:"loading-container"},Lt={key:2,class:"empty-state"},Ut={class:"modal-content"},Vt={class:"modal-header"},Ft={class:"modal-body"},Wt={class:"form-group"},Ht={class:"form-group"},$t={class:"form-group"},xt={class:"form-group"},Bt=["value"],Qt={class:"form-group"},Kt={class:"form-actions"},Jt=["disabled"],jt={class:"modal-content modal-wide"},qt={class:"modal-header"},zt={class:"modal-body"},Yt={class:"permission-table-container"},Xt={class:"permission-table"},Zt={class:"role-name"},ea={class:"permission-cell"},ta=["checked","onChange"],aa={class:"permission-cell"},sa=["checked","onChange"],ia={class:"permission-cell"},na=["checked","onChange"],oa={class:"permission-cell"},ra=["checked","onChange"],_a={class:"permission-cell"},pa=["checked","onChange"],da={class:"form-actions"},la=["disabled"],ca={class:"modal-content modal-large"},ma={class:"modal-header"},ua={class:"modal-body"},ha={class:"endpoint-form"},ga={class:"endpoint-filters"},va={class:"form-group"},ya={class:"form-group"},Ia=["value"],Ea={class:"form-group"},Ta=["value"],ka={class:"available-endpoints-list"},Da={class:"available-endpoints-count"},Aa={class:"available-endpoints-scroll"},fa=["onClick"],ba={class:"endpoint-detail"},Ma={class:"endpoint-path"},Ga={class:"endpoint-summary"},Pa=["disabled"],Na={class:"endpoints-list"},wa={key:0,class:"empty-message"},Ca={key:1,class:"endpoint-items"},Sa={class:"endpoint-info"},Ra={class:"endpoint-path"},Oa={class:"endpoint-desc"},La=["onClick"],Ua=we({__name:"MenuManagementView",setup(T){const c=new Oe(ve()),d=Ue(),I=m([]),G=m([]),S=m(!1),k=m(!1),z=m(null),R=m(""),D=m(new Set),Y=m(),O=m(!1),i=m({name:"",path:"",icon:"",parent_id:null,sort_order:999}),u=m(!1),n=m(null),h=m(new Map),N=m(!1),P=m([]),X=m(!1),H=m([]),$=m([]),L=m(""),A=m(null),U=m(""),V=m(""),F=m(new Map),re=["ADMIN","MANAGER","OPERATOR","DRIVER","VIEWER"],ye=["GET","POST","PUT","DELETE","PATCH"],Ie=ie(()=>{const s=new Set;return H.value.forEach(t=>{t.tags.forEach(_=>s.add(_))}),Array.from(s).sort()}),_e=ie(()=>{const s=I.value.filter(g=>{var a;if(R.value){const v=R.value.toLowerCase();if(!g.name.toLowerCase().includes(v)&&!((a=g.path)!=null&&a.toLowerCase().includes(v)))return!1}return!0}),t=s.filter(g=>!g.parent_id),_=g=>s.filter(a=>a.parent_id===g).map(a=>({...a,children:_(a.id)})).sort((a,v)=>(a.sort_order||999)-(v.sort_order||999));return t.map(g=>({...g,children:_(g.id)})).sort((g,a)=>(g.sort_order||999)-(a.sort_order||999))}),Ee=ie(()=>I.value.filter(s=>{let t=0,_=s;for(;_.parent_id&&t<2;)_=I.value.find(g=>g.id===_.parent_id)||_,t++;return t<2}).map(s=>{const t=s.parent_id?I.value.find(_=>_.id===s.parent_id):null;return{...s,parent_name:t==null?void 0:t.name}})),x=async()=>{try{S.value=!0,z.value=null;const s=await c.getMenusApiMenusGet();if(s.data){const t=Array.isArray(s.data)?s.data:s.data.items||[];I.value=t,t.filter(_=>!_.parent_id).forEach(_=>D.value.add(_.id))}await pe()}catch(s){console.error("Failed to load menus:",s),z.value=s.message}finally{S.value=!1}},pe=async()=>{try{const s=[];for(const t of re)try{const _=await c.getRoleMenuPermissionsApiMenusPermissionsRoleGet(t);if(_.data&&_.data.menus){const g=_.data.menus.filter(a=>a.id!==void 0).map(a=>({role:_.data.role,menu_id:a.id,can_read:a.can_read??!1,can_create:a.can_create??!1,can_update:a.can_update??!1,can_delete:a.can_delete??!1}));s.push(...g)}}catch{}s.length>0&&(G.value=s)}catch(s){console.error("Failed to load permissions:",s)}},B=s=>{s?i.value={id:s.id,name:s.name,path:s.path,icon:s.icon,parent_id:s.parent_id,sort_order:s.sort_order}:i.value={name:"",path:"",icon:"",parent_id:null,sort_order:999},O.value=!0},de=s=>{i.value={name:"",path:s.path+"/",icon:"",parent_id:s.id,sort_order:999},O.value=!0},Q=()=>{O.value=!1,i.value={}},Te=async()=>{try{k.value=!0,i.value.id?await c.updateMenuApiMenusMenuIdPut(i.value.id,i.value):await c.createMenuApiMenusPost(i.value),Q(),await x()}catch(s){console.error("Failed to save menu:",s),alert("메뉴 저장 실패: "+s.message)}finally{k.value=!1}},Z=async s=>{if(confirm(`"${s.name}" 메뉴를 삭제하시겠습니까?`))try{await c.deleteMenuApiMenusMenuIdDelete(s.id),await x()}catch(t){console.error("Failed to delete menu:",t),alert("메뉴 삭제 실패: "+t.message)}},le=s=>{D.value.has(s)?D.value.delete(s):D.value.add(s)},ee=s=>{n.value=s,h.value.clear(),G.value.filter(t=>t.menu_id===s.id&&t.role).forEach(t=>{t.role&&h.value.set(t.role,{can_read:t.can_read||!1,can_create:t.can_create||!1,can_update:t.can_update||!1,can_delete:t.can_delete||!1})}),u.value=!0},K=()=>{u.value=!1,n.value=null,h.value.clear()},J=(s,t)=>{const _=h.value.get(s);return _?_[t]:!1},j=(s,t)=>{const _=h.value.get(s)||{can_read:!1,can_create:!1,can_update:!1,can_delete:!1};_[t]=!_[t],h.value.set(s,{..._})},ce=s=>{const t=h.value.get(s);return t?t.can_read&&t.can_create&&t.can_update&&t.can_delete:!1},ke=s=>{const t=ce(s);h.value.set(s,{can_read:!t,can_create:!t,can_update:!t,can_delete:!t})},De=async()=>{var s;if(n.value)try{k.value=!0;for(const[t,_]of h.value.entries()){const g=_.can_read||_.can_create||_.can_update||_.can_delete;try{let v=(await c.getRoleMenuPermissionsApiMenusPermissionsRoleGet(t)).data.menu_ids||[];g?v.includes(n.value.id)||v.push(n.value.id):v=v.filter(l=>l!==n.value.id),v.length>0?await c.updateRoleMenuPermissionsApiMenusPermissionsRolePut(t,{role:t,menu_ids:v}):await c.deleteRoleMenuPermissionsApiMenusPermissionsRoleDelete(t)}catch(a){if(((s=a.response)==null?void 0:s.status)===404)g&&await c.setRoleMenuPermissionsApiMenusPermissionsPost({role:t,menu_ids:[n.value.id]});else throw a}}await pe(),K()}catch(t){console.error("Failed to save permissions:",t),alert("권한 저장 실패: "+t.message)}finally{k.value=!1}},Ae=s=>({ADMIN:"관리자",MANAGER:"매니저",OPERATOR:"운영자",DRIVER:"운전자",VIEWER:"조회자"})[s]||s,fe=()=>{clearTimeout(Y.value),Y.value=setTimeout(()=>{},300)},te=async s=>{n.value=s,N.value=!0,await d.loadMenuApiEndpoints(s.id),P.value=d.endpoints,H.value=Ve(),L.value="",U.value="",V.value="",A.value=null,q()},ae=()=>{N.value=!1,n.value=null,P.value=[],H.value=[],$.value=[]},q=()=>{let s=H.value;L.value&&(s=Fe(L.value)),U.value&&(s=s.filter(t=>t.method===U.value)),V.value&&(s=s.filter(t=>t.tags.includes(V.value))),$.value=s},be=s=>{A.value=s},Me=async()=>{if(!(!n.value||!A.value))try{X.value=!0,await d.createMenuApiEndpoint(n.value.id,{menu_id:n.value.id,method:A.value.method,path:A.value.path,description:A.value.summary||void 0}),await d.loadMenuApiEndpoints(n.value.id),P.value=d.endpoints,F.value.set(n.value.id,d.endpoints.length),A.value=null}catch(s){console.error("Failed to add API endpoint:",s),alert("API 엔드포인트 추가 실패: "+s.message)}finally{X.value=!1}},Ge=async s=>{if(n.value&&confirm("이 API 엔드포인트를 삭제하시겠습니까?"))try{await d.deleteMenuApiEndpoint(n.value.id,s),await d.loadMenuApiEndpoints(n.value.id),P.value=d.endpoints,F.value.set(n.value.id,d.endpoints.length)}catch(t){console.error("Failed to delete API endpoint:",t),alert("API 엔드포인트 삭제 실패: "+t.message)}},me=s=>d.getMethodColor(s),w=s=>F.value.get(s)||0,Pe=async()=>{try{for(const s of I.value)try{await d.loadMenuApiEndpoints(s.id),F.value.set(s.id,d.endpoints.length)}catch{F.value.set(s.id,0)}}catch(s){console.error("Failed to load menu API counts:",s)}};return Ce(async()=>{await x(),await Pe()}),(s,t)=>{var _,g;return r(),o("div",We,[t[29]||(t[29]=e("div",{class:"page-header"},[e("h1",null,"메뉴 관리"),e("p",{class:"subtitle"},"시스템 메뉴와 권한을 관리합니다.")],-1)),e("div",He,[e("div",$e,[t[10]||(t[10]=e("label",null,"검색",-1)),f(e("input",{"onUpdate:modelValue":t[0]||(t[0]=a=>R.value=a),type:"text",class:"form-control",placeholder:"메뉴명, 경로 검색",onInput:fe},null,544),[[C,R.value]])]),e("button",{onClick:t[1]||(t[1]=a=>B()),class:"btn btn-primary"},t[11]||(t[11]=[e("span",{class:"icon"},"+",-1),he(" 새 메뉴 ",-1)])),e("button",{onClick:x,class:"btn btn-secondary"},t[12]||(t[12]=[e("span",{class:"icon"},"🔄",-1),he(" 새로고침 ",-1)]))]),S.value?(r(),o("div",Ot,t[14]||(t[14]=[e("div",{class:"spinner"},null,-1),e("p",null,"메뉴를 불러오는 중...",-1)]))):(r(),o("div",xe,[e("div",Be,[(r(!0),o(b,null,M(_e.value,a=>{var v;return r(),o("div",{key:a.id,class:"tree-node"},[e("div",Qe,[e("div",Ke,[a.children&&a.children.length?(r(),o("span",{key:0,class:"expand-icon",onClick:l=>le(a.id)},p(D.value.has(a.id)?"▼":"▶"),9,Je)):(r(),o("span",je,"▶")),e("span",qe,p(a.icon||"📄"),1),e("span",ze,p(a.name),1),e("span",Ye,p(a.path),1),e("span",Xe,"["+p(a.sort_order)+"]",1),w(a.id)>0?(r(),o("span",Ze," API: "+p(w(a.id)),1)):E("",!0)]),e("div",et,[e("button",{onClick:l=>te(a),class:"btn-icon",title:"API 엔드포인트"}," 📡 ",8,tt),e("button",{onClick:l=>ee(a),class:"btn-icon",title:"권한 설정"}," 🔐 ",8,at),e("button",{onClick:l=>B(a),class:"btn-icon",title:"수정"},"✏️",8,st),e("button",{onClick:l=>de(a),class:"btn-icon",title:"하위 메뉴 추가"}," ➕ ",8,it),(v=a.children)!=null&&v.length?E("",!0):(r(),o("button",{key:0,onClick:l=>Z(a),class:"btn-icon",title:"삭제"}," 🗑️ ",8,nt))])]),a.children&&a.children.length&&D.value.has(a.id)?(r(),o("div",ot,[(r(!0),o(b,null,M(a.children,l=>{var ue;return r(),o("div",{key:l.id,class:"tree-node child-node"},[e("div",rt,[e("div",_t,[l.children&&l.children.length?(r(),o("span",{key:0,class:"expand-icon",onClick:y=>le(l.id)},p(D.value.has(l.id)?"▼":"▶"),9,pt)):(r(),o("span",dt,"▶")),e("span",lt,p(l.icon||"📄"),1),e("span",ct,p(l.name),1),e("span",mt,p(l.path),1),e("span",ut,"["+p(l.sort_order)+"]",1),w(l.id)>0?(r(),o("span",ht," API: "+p(w(l.id)),1)):E("",!0)]),e("div",gt,[e("button",{onClick:y=>te(l),class:"btn-icon",title:"API 엔드포인트"}," 📡 ",8,vt),e("button",{onClick:y=>ee(l),class:"btn-icon",title:"권한 설정"}," 🔐 ",8,yt),e("button",{onClick:y=>B(l),class:"btn-icon",title:"수정"},"✏️",8,It),e("button",{onClick:y=>de(l),class:"btn-icon",title:"하위 메뉴 추가"}," ➕ ",8,Et),(ue=l.children)!=null&&ue.length?E("",!0):(r(),o("button",{key:0,onClick:y=>Z(l),class:"btn-icon",title:"삭제"}," 🗑️ ",8,Tt))])]),l.children&&l.children.length&&D.value.has(l.id)?(r(),o("div",kt,[(r(!0),o(b,null,M(l.children,y=>(r(),o("div",{key:y.id,class:"tree-node grandchild-node"},[e("div",Dt,[e("div",At,[t[13]||(t[13]=e("span",{class:"expand-icon",style:{visibility:"hidden"}},"▶",-1)),e("span",ft,p(y.icon||"📄"),1),e("span",bt,p(y.name),1),e("span",Mt,p(y.path),1),e("span",Gt,"["+p(y.sort_order)+"]",1),w(y.id)>0?(r(),o("span",Pt," API: "+p(w(y.id)),1)):E("",!0)]),e("div",Nt,[e("button",{onClick:se=>te(y),class:"btn-icon",title:"API 엔드포인트"}," 📡 ",8,wt),e("button",{onClick:se=>ee(y),class:"btn-icon",title:"권한 설정"}," 🔐 ",8,Ct),e("button",{onClick:se=>B(y),class:"btn-icon",title:"수정"}," ✏️ ",8,St),e("button",{onClick:se=>Z(y),class:"btn-icon",title:"삭제"}," 🗑️ ",8,Rt)])])]))),128))])):E("",!0)])}),128))])):E("",!0)])}),128))])])),!S.value&&_e.value.length===0?(r(),o("div",Lt,t[15]||(t[15]=[e("p",null,"메뉴가 없습니다.",-1)]))):E("",!0),O.value?(r(),o("div",{key:3,class:"modal-overlay",onClick:W(Q,["self"])},[e("div",Ut,[e("div",Vt,[e("h2",null,p(i.value.id?"메뉴 수정":"새 메뉴 추가"),1),e("button",{onClick:Q,class:"close-btn"},"×")]),e("div",Ft,[e("form",{onSubmit:W(Te,["prevent"])},[e("div",Wt,[t[16]||(t[16]=e("label",null,"메뉴명 *",-1)),f(e("input",{"onUpdate:modelValue":t[2]||(t[2]=a=>i.value.name=a),type:"text",class:"form-control",required:"",placeholder:"예: 대시보드"},null,512),[[C,i.value.name]])]),e("div",Ht,[t[17]||(t[17]=e("label",null,"경로 *",-1)),f(e("input",{"onUpdate:modelValue":t[3]||(t[3]=a=>i.value.path=a),type:"text",class:"form-control",required:"",placeholder:"예: /dashboard"},null,512),[[C,i.value.path]])]),e("div",$t,[t[18]||(t[18]=e("label",null,"아이콘",-1)),f(e("input",{"onUpdate:modelValue":t[4]||(t[4]=a=>i.value.icon=a),type:"text",class:"form-control",placeholder:"예: 📊"},null,512),[[C,i.value.icon]])]),e("div",xt,[t[20]||(t[20]=e("label",null,"부모 메뉴",-1)),f(e("select",{"onUpdate:modelValue":t[5]||(t[5]=a=>i.value.parent_id=a),class:"form-control"},[t[19]||(t[19]=e("option",{value:null},"없음 (최상위 메뉴)",-1)),(r(!0),o(b,null,M(Ee.value,a=>(r(),o("option",{key:a.id,value:a.id},p(a.name)+" "+p(a.parent_name?`(${a.parent_name})`:""),9,Bt))),128))],512),[[ne,i.value.parent_id]])]),e("div",Qt,[t[21]||(t[21]=e("label",null,"정렬 순서",-1)),f(e("input",{"onUpdate:modelValue":t[6]||(t[6]=a=>i.value.sort_order=a),type:"number",class:"form-control",placeholder:"999"},null,512),[[C,i.value.sort_order,void 0,{number:!0}]])]),e("div",Kt,[e("button",{type:"submit",class:"btn btn-primary",disabled:k.value},p(k.value?"저장 중...":"저장"),9,Jt),e("button",{type:"button",onClick:Q,class:"btn btn-secondary"},"취소")])],32)])])])):E("",!0),u.value?(r(),o("div",{key:4,class:"modal-overlay",onClick:W(K,["self"])},[e("div",jt,[e("div",qt,[e("h2",null,"권한 설정: "+p((_=n.value)==null?void 0:_.name),1),e("button",{onClick:K,class:"close-btn"},"×")]),e("div",zt,[e("div",Yt,[e("table",Xt,[t[22]||(t[22]=e("thead",null,[e("tr",null,[e("th",null,"역할"),e("th",null,"조회 (GET)"),e("th",null,"생성 (POST)"),e("th",null,"수정 (PUT/PATCH)"),e("th",null,"삭제 (DELETE)"),e("th",null,"전체")])],-1)),e("tbody",null,[(r(),o(b,null,M(re,a=>e("tr",{key:a},[e("td",Zt,p(Ae(a)),1),e("td",ea,[e("input",{type:"checkbox",checked:J(a,"can_read"),onChange:v=>j(a,"can_read")},null,40,ta)]),e("td",aa,[e("input",{type:"checkbox",checked:J(a,"can_create"),onChange:v=>j(a,"can_create")},null,40,sa)]),e("td",ia,[e("input",{type:"checkbox",checked:J(a,"can_update"),onChange:v=>j(a,"can_update")},null,40,na)]),e("td",oa,[e("input",{type:"checkbox",checked:J(a,"can_delete"),onChange:v=>j(a,"can_delete")},null,40,ra)]),e("td",_a,[e("input",{type:"checkbox",checked:ce(a),onChange:v=>ke(a)},null,40,pa)])])),64))])])]),e("div",da,[e("button",{onClick:De,class:"btn btn-primary",disabled:k.value},p(k.value?"저장 중...":"권한 저장"),9,la),e("button",{onClick:K,class:"btn btn-secondary"},"닫기")])])])])):E("",!0),N.value?(r(),o("div",{key:5,class:"modal-overlay",onClick:W(ae,["self"])},[e("div",ca,[e("div",ma,[e("h2",null,"API 엔드포인트: "+p((g=n.value)==null?void 0:g.name),1),e("button",{onClick:ae,class:"close-btn"},"×")]),e("div",ua,[e("div",ha,[t[28]||(t[28]=e("h3",null,"새 엔드포인트 추가",-1)),e("div",ga,[e("div",va,[t[23]||(t[23]=e("label",null,"검색",-1)),f(e("input",{"onUpdate:modelValue":t[7]||(t[7]=a=>L.value=a),type:"text",class:"form-control",placeholder:"경로, 설명, 태그 검색...",onInput:q},null,544),[[C,L.value]])]),e("div",ya,[t[25]||(t[25]=e("label",null,"메소드",-1)),f(e("select",{"onUpdate:modelValue":t[8]||(t[8]=a=>U.value=a),class:"form-control",onChange:q},[t[24]||(t[24]=e("option",{value:""},"전체",-1)),(r(),o(b,null,M(ye,a=>e("option",{key:a,value:a},p(a),9,Ia)),64))],544),[[ne,U.value]])]),e("div",Ea,[t[27]||(t[27]=e("label",null,"태그",-1)),f(e("select",{"onUpdate:modelValue":t[9]||(t[9]=a=>V.value=a),class:"form-control",onChange:q},[t[26]||(t[26]=e("option",{value:""},"전체",-1)),(r(!0),o(b,null,M(Ie.value,a=>(r(),o("option",{key:a,value:a},p(a),9,Ta))),128))],544),[[ne,V.value]])])]),e("div",ka,[e("div",Da," 사용 가능한 엔드포인트: "+p($.value.length)+"개 ",1),e("div",Aa,[(r(!0),o(b,null,M($.value,a=>(r(),o("div",{key:`${a.method}-${a.path}`,class:Se(["available-endpoint-item",{selected:A.value===a}]),onClick:v=>be(a)},[e("span",{class:"method-badge",style:ge({background:me(a.method)})},p(a.method),5),e("div",ba,[e("div",Ma,p(a.path),1),e("div",Ga,p(a.summary),1)]),A.value===a?(r(),o("button",{key:0,type:"button",onClick:W(Me,["stop"]),class:"btn btn-sm btn-primary",disabled:X.value}," 추가 ",8,Pa)):E("",!0)],10,fa))),128))])])]),e("div",Na,[e("h3",null,"등록된 엔드포인트 ("+p(P.value.length)+"개)",1),P.value.length===0?(r(),o("div",wa," 등록된 API 엔드포인트가 없습니다. ")):(r(),o("div",Ca,[(r(!0),o(b,null,M(P.value,a=>(r(),o("div",{key:a.id,class:"endpoint-item"},[e("div",Sa,[e("span",{class:"method-badge",style:ge({background:me(a.method)})},p(a.method),5),e("span",Ra,p(a.path),1),e("span",Oa,p(a.description),1)]),e("button",{onClick:v=>Ge(a.id),class:"btn-icon",title:"삭제"}," 🗑️ ",8,La)]))),128))]))]),e("div",{class:"form-actions"},[e("button",{onClick:ae,class:"btn btn-secondary"},"닫기")])])])])):E("",!0)])}}}),$a=Re(Ua,[["__scopeId","data-v-be351f5b"]]);export{$a as default};
