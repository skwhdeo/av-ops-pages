import{B as we,l as u,d as Ce,c as ie,H as Ne,a as o,t as e,x as E,C as f,G as N,z as he,F as b,f as G,I as W,v as _,D as ne,u as Re,O as ge,o as r}from"./vendor-CJYFYo_D.js";import{j as ve,_ as Se}from"./index-R-gcltw4.js";import{b as Oe}from"./menus-api-DVy_gTBZ.js";import{b as Le}from"./menu-api-endpoints-api-DlOJnLmi.js";const Ue=we("menuApiEndpoints",()=>{const T=u([]),c=u(!1),d=u(null),I=new Le(ve()),M=async i=>{try{c.value=!0,d.value=null,console.log("📡 Loading menu API endpoints for menu:",i);const m=await I.getMenuApiEndpointsApiMenusMenuIdApiEndpointsGet(i);m.data?(T.value=Array.isArray(m.data)?m.data:[m.data],console.log("✅ Loaded menu API endpoints:",T.value)):T.value=[]}catch(m){console.error("❌ Failed to load menu API endpoints:",m),d.value=`메뉴 API 엔드포인트 조회 실패: ${m.message}`,T.value=[]}finally{c.value=!1}};return{endpoints:T,loading:c,error:d,loadMenuApiEndpoints:M,searchMenuApiEndpoints:async(i,m,n)=>{try{c.value=!0,d.value=null,console.log("📡 Searching menu API endpoints:",{path:i,method:m,menuId:n});const h=await I.searchMenuApiEndpointsApiMenusApiEndpointsSearchGet(i,m,n);if(h.data){const w=Array.isArray(h.data)?h.data:[h.data];return console.log("✅ Found menu API endpoints:",w),w}return[]}catch(h){return console.error("❌ Failed to search menu API endpoints:",h),d.value=`메뉴 API 엔드포인트 검색 실패: ${h.message}`,[]}finally{c.value=!1}},createMenuApiEndpoint:async(i,m)=>{try{c.value=!0,d.value=null,console.log("📡 Creating menu API endpoint:",i,m);const n=await I.createMenuApiEndpointApiMenusMenuIdApiEndpointsPost(i,m);return console.log("✅ Created menu API endpoint:",n.data),await M(i),n.data}catch(n){throw console.error("❌ Failed to create menu API endpoint:",n),d.value=`메뉴 API 엔드포인트 생성 실패: ${n.message}`,n}finally{c.value=!1}},updateMenuApiEndpoint:async(i,m,n)=>{try{c.value=!0,d.value=null,console.log("📡 Updating menu API endpoint:",i,m,n);const h=await I.updateMenuApiEndpointApiMenusMenuIdApiEndpointsEndpointIdPut(i,m,n);return console.log("✅ Updated menu API endpoint:",h.data),await M(i),h.data}catch(h){throw console.error("❌ Failed to update menu API endpoint:",h),d.value=`메뉴 API 엔드포인트 수정 실패: ${h.message}`,h}finally{c.value=!1}},deleteMenuApiEndpoint:async(i,m)=>{try{c.value=!0,d.value=null,console.log("📡 Deleting menu API endpoint:",i,m),await I.deleteMenuApiEndpointApiMenusMenuIdApiEndpointsEndpointIdDelete(i,m),console.log("✅ Deleted menu API endpoint"),await M(i)}catch(n){throw console.error("❌ Failed to delete menu API endpoint:",n),d.value=`메뉴 API 엔드포인트 삭제 실패: ${n.message}`,n}finally{c.value=!1}},httpMethods:["GET","POST","PUT","DELETE","PATCH"],getMethodColor:i=>({GET:"#10b981",POST:"#3b82f6",PUT:"#f59e0b",DELETE:"#ef4444",PATCH:"#8b5cf6"})[i]||"#6b7280",hasWildcard:i=>i.includes("*")}}),oe=[{path:"/api/auth/token",method:"POST",summary:"토큰 발급",description:"OAuth2 토큰 발급 (password / client_credentials grant)",operationId:"login_for_access_token_api_auth_token_post",tags:["auth"]},{path:"/api/auth/login",method:"POST",summary:"사용자 로그인 (별칭)",description:"토큰 엔드포인트의 별칭 - 일반적인 REST API 패턴 지원",operationId:"login_alias_api_auth_login_post",tags:["auth"]},{path:"/api/auth/logout",method:"POST",summary:"로그아웃",description:"로그아웃 이벤트를 기록합니다",operationId:"logout_api_auth_logout_post",tags:["auth"]},{path:"/api/auth/my-permissions",method:"GET",summary:"현재 사용자의 메뉴 권한 조회",description:"현재 로그인한 사용자의 메뉴별 CRUD 권한을 조회합니다 (프론트엔드 버튼 제어용)",operationId:"get_my_permissions_api_auth_my_permissions_get",tags:["auth"]},{path:"/api/auth/2fa/enable",method:"POST",summary:"Enable 2Fa",description:`2FA 활성화 시작 - QR 코드 및 백업 코드 생성
...
Returns:
    backup_codes: 새로 생성된 백업 코드 리스트`,operationId:"regenerate_backup_codes_api_auth_2fa_regenerate_backup_codes_post",tags:["auth"]},{path:"/api/auth/refresh",method:"POST",summary:"Refresh Access Token",description:`Access Token 갱신

Refresh Token은 HttpOnly Cookie에서 자동으로 가져옴
Token Rotation: 새 Refresh Token 발급, 기존 것 무효화`,operationId:"refresh_access_token_api_auth_refresh_post",tags:["auth"]},{path:"/api/auth/logout-all",method:"POST",summary:"Logout All Sessions",description:`모든 기기에서 로그아웃
...
**필요한 권한:** DRIVER, ADMIN`,operationId:"complete_inspection_api_trips__trip_id__inspection_complete_post",tags:["trips"]},{path:"/api/trips/{trip_id}/complete",method:"POST",summary:"Complete Trip",description:`Trip 운행 완료 처리
...
**필요한 권한:** DRIVER, ADMIN`,operationId:"complete_trip_api_trips__trip_id__complete_post",tags:["trips"]},{path:"/api/calls",method:"GET",summary:"Get Calls",description:`호출 목록 조회
...
**필요한 권한:** DRIVER, ADMIN`,operationId:"get_today_trips_api_driver_app_trips_today_get",tags:["driver-app"]},{path:"/api/driver-app/trips/{trip_id}",method:"GET",summary:"Get Driver Trip",description:`개별 Trip 정보 조회 (Call 및 Seat 정보 포함 가능)
...
**필요한 권한:** DRIVER, ADMIN`,operationId:"get_screen_config_api_driver_app_screens__screen_type__get",tags:["driver-app"]},{path:"/api/driver-app/events",method:"POST",summary:"Send Event",description:`이벤트/긴급 전송 
...
**필요한 권한:** DRIVER, ADMIN`,operationId:"send_event_api_driver_app_events_post",tags:["driver-app"]},{path:"/api/driver-app/events",method:"GET",summary:"Get Events",description:`이벤트 목록 조회 (본인이 보고한 이벤트만)

**필요한 권한:** DRIVER, ADMIN`,operationId:"get_events_api_driver_app_events_get",tags:["driver-app"]},{path:"/api/driver-app/events/{event_id}",method:"GET",summary:"Get Event Detail",description:`이벤트 상세 조회

**필요한 권한:** DRIVER, ADMIN`,operationId:"get_event_detail_api_driver_app_events__event_id__get",tags:["driver-app"]},{path:"/api/driver-app/trips/{trip_id}/start",method:"POST",summary:"Start Trip",description:`Trip 강제 운행시작 처리

- SCHEDULED 상태의 Trip을 IN_PROGRESS로 전환
- 차량/운전자 상태 업데이트
- 관련 이벤트 처리

**필요한 권한:** DRIVER, ADMIN`,operationId:"start_trip_api_driver_app_trips__trip_id__start_post",tags:["driver-app"]},{path:"/api/driver-app/trips/{trip_id}/complete",method:"POST",summary:"Complete Trip",description:`운전자가 Trip 운행 완료 처리
...
**필요한 권한:** DRIVER, ADMIN`,operationId:"complete_trip_api_driver_app_trips__trip_id__complete_post",tags:["driver-app"]},{path:"/api/driver-app/assigned-drivers",method:"GET",summary:"차량 배정 운전자 목록 조회",description:`차량 배정 운전자 목록 조회
...
**필요한 권한:** DRIVER, ADMIN`,operationId:"create_walk_in_calls_api_driver_app_trips__trip_id__walk_in_post",tags:["driver-app"]},{path:"/api/driver-app/trips/{trip_id}/seat-status",method:"GET",summary:"Get Trip Seat Status",description:`Trip의 좌석 현황 조회

- 전체 좌석 상태
- 구간별 좌석 사용 현황
- node_id 지정 시 해당 정류장 기준

**필요한 권한:** DRIVER, ADMIN`,operationId:"get_trip_seat_status_api_driver_app_trips__trip_id__seat_status_get",tags:["driver-app"]},{path:"/api/driver-app/calls/{call_id}/seats/confirm",method:"POST",summary:"Confirm Call Seats Boarding",description:`Call 기반 좌석별 탑승 확인 (복수 좌석 지원)

- 예약된 좌석들의 실제 탑승 확인
- 모든 좌석 탑승 시 Call을 IN_PROGRESS로 변경
- 탑승 시간 기록

**필요한 권한:** DRIVER, ADMIN`,operationId:"confirm_call_seats_boarding_api_driver_app_calls__call_id__seats_confirm_post",tags:["driver-app"]},{path:"/api/driver-app/trips/{trip_id}/seats/occupy",method:"POST",summary:"Occupy Seats",description:`좌석 점유 처리 (비정상 상황)

- 미하차, 오염 등으로 좌석 사용 불가
- SeatOccupancy 생성하여 점유 표시
- 이후 Trip에서도 사용 불가

**필요한 권한:** DRIVER, ADMIN`,operationId:"occupy_seats_api_driver_app_trips__trip_id__seats_occupy_post",tags:["driver-app"]},{path:"/api/driver-app/trips/{trip_id}/seats/occupy",method:"DELETE",summary:"Release Occupied Seats",description:`점유 좌석 해제

- 점유 상태 좌석을 사용 가능하게 변경
- SeatOccupancy의 is_occupied를 False로

**필요한 권한:** DRIVER, ADMIN`,operationId:"release_occupied_seats_api_driver_app_trips__trip_id__seats_occupy_delete",tags:["driver-app"]},{path:"/api/driver-app/trips/{trip_id}/seats/alight",method:"POST",summary:"Alight Trip Seats",description:`Trip 기반 좌석 하차 처리 (단일/복수 지원)

- Trip ID와 좌석 번호로 직접 하차 처리
- seat_numbers에 여러 좌석 전달 시 일괄 처리
- node_id 미지정 시 차량의 현재 정류장 사용

**필요한 권한:** DRIVER, ADMIN`,operationId:"alight_trip_seats_api_driver_app_trips__trip_id__seats_alight_post",tags:["driver-app"]},{path:"/api/driver-app/calls/{call_id}/seats/no-show",method:"POST",summary:"Mark Call Seats No Show",description:`Call 기반 좌석별 미탑승 처리 (운전자 수동 처리)
...
**필요한 권한:** DRIVER, ADMIN`,operationId:"mark_call_seats_no_show_api_driver_app_calls__call_id__seats_no_show_post",tags:["driver-app"]},{path:"/api/pvd/batch",method:"POST",summary:"PVD 백업 데이터 저장 (지연 전송)",description:`PVD 원본 데이터를 pvd_raw_data 테이블에 저장 (백업/분석용)

- /message와 동일한 형식 (vehicle_id는 쿼리 파라미터, data는 body)
- 실시간 처리 없이 단순 저장만 수행
- 디버깅 및 사후 분석을 위한 원본 데이터 보관
- 차량 상태 업데이트, WebSocket 브로드캐스트, ETA 계산 등 실시간 처리는 하지 않음`,operationId:"save_pvd_batch_api_pvd_batch_post",tags:["pvd"]},{path:"/api/pvd/message",method:"POST",summary:"PVD 통합 메시지 수신",description:`최적화된 PVD 메시지 처리
- 명시적 세션 관리로 연결 풀 보호
- DB 작업 최소화
- WebSocket 브로드캐스트는 비동기로 처리`,operationId:"receive_pvd_message_api_pvd_message_post",tags:["pvd"]},{path:"/api/webhooks/register",method:"POST",summary:"Register Webhook",description:`Webhook 등록
...
**필요한 권한:** DRIVER, ADMIN`,operationId:"get_event_detail_api_events__event_id__get",tags:["events"]},{path:"/api/events/{event_id}",method:"PATCH",summary:"이벤트 수정",description:`이벤트 정보를 수정합니다
...
**필요한 권한:** DRIVER, ADMIN`,operationId:"get_event_memos_api_events__event_id__memos_get",tags:["events"]},{path:"/api/parameters",method:"POST",summary:"Create Parameter",description:`새 시스템 파라미터 생성
...
Returns:
    현재 연결 상태 정보`,operationId:"get_websocket_status_api_websocket_status_get",tags:["websocket"]},{path:"/api/health",method:"GET",summary:"Health Check",description:"시스템 상태 및 DB 연결 풀 상태 확인",operationId:"health_check_api_health_get",tags:["monitoring"]},{path:"/",method:"GET",summary:"프론트엔드 리다이렉트",description:"루트 경로 접속 시 정적 HTML 페이지로 리다이렉트",operationId:"read_root__get",tags:["system"]},{path:"/api/version",method:"GET",summary:"시스템 버전 정보",description:"현재 배포된 시스템의 Git 커밋 정보 조회",operationId:"get_version_api_version_get",tags:["system"]}];function Ve(){return oe}function Fe(T){if(!T)return oe;const c=T.toLowerCase();return oe.filter(d=>d.path.toLowerCase().includes(c)||d.method.toLowerCase().includes(c)||d.summary.toLowerCase().includes(c)||d.description.toLowerCase().includes(c)||d.operationId.toLowerCase().includes(c)||d.tags.some(I=>I.toLowerCase().includes(c)))}const We={class:"menu-management"},He={class:"filters-section"},$e={class:"filter-group"},xe={key:0,class:"menu-tree"},Be={class:"tree-container"},Qe={class:"node-content"},Ke={class:"node-info"},je=["onClick"],Je={key:1,class:"expand-icon",style:{visibility:"hidden"}},ze={class:"menu-icon"},qe={class:"menu-name"},Ye={class:"menu-path"},Xe={class:"menu-order"},Ze={key:2,class:"api-count-badge"},et={class:"node-actions"},tt=["onClick"],at=["onClick"],st=["onClick"],it=["onClick"],nt=["onClick"],ot={key:0,class:"tree-children"},rt={class:"node-content"},pt={class:"node-info"},_t=["onClick"],dt={key:1,class:"expand-icon",style:{visibility:"hidden"}},lt={class:"menu-icon"},ct={class:"menu-name"},ut={class:"menu-path"},mt={class:"menu-order"},ht={key:2,class:"api-count-badge"},gt={class:"node-actions"},vt=["onClick"],yt=["onClick"],It=["onClick"],Et=["onClick"],Tt=["onClick"],kt={key:0,class:"tree-children"},Dt={class:"node-content"},At={class:"node-info"},ft={class:"menu-icon"},bt={class:"menu-name"},Gt={class:"menu-path"},Mt={class:"menu-order"},Pt={key:0,class:"api-count-badge"},wt={class:"node-actions"},Ct=["onClick"],Nt=["onClick"],Rt=["onClick"],St=["onClick"],Ot={key:1,class:"loading-container"},Lt={key:2,class:"empty-state"},Ut={class:"modal-content"},Vt={class:"modal-header"},Ft={class:"modal-body"},Wt={class:"form-group"},Ht={class:"form-group"},$t={class:"form-group"},xt={class:"form-group"},Bt=["value"],Qt={class:"form-group"},Kt={class:"form-actions"},jt=["disabled"],Jt={class:"modal-content modal-wide"},zt={class:"modal-header"},qt={class:"modal-body"},Yt={class:"permission-table-container"},Xt={class:"permission-table"},Zt={class:"role-name"},ea={class:"permission-cell"},ta=["checked","onChange"],aa={class:"permission-cell"},sa=["checked","onChange"],ia={class:"permission-cell"},na=["checked","onChange"],oa={class:"permission-cell"},ra=["checked","onChange"],pa={class:"permission-cell"},_a=["checked","onChange"],da={class:"form-actions"},la=["disabled"],ca={class:"modal-content modal-large"},ua={class:"modal-header"},ma={class:"modal-body"},ha={class:"endpoint-form"},ga={class:"endpoint-filters"},va={class:"form-group"},ya={class:"form-group"},Ia=["value"],Ea={class:"form-group"},Ta=["value"],ka={class:"available-endpoints-list"},Da={class:"available-endpoints-count"},Aa={class:"available-endpoints-scroll"},fa=["onClick"],ba={class:"endpoint-detail"},Ga={class:"endpoint-path"},Ma={class:"endpoint-summary"},Pa=["disabled"],wa={class:"endpoints-list"},Ca={key:0,class:"empty-message"},Na={key:1,class:"endpoint-items"},Ra={class:"endpoint-info"},Sa={class:"endpoint-path"},Oa={class:"endpoint-desc"},La=["onClick"],Ua=Ce({__name:"MenuManagementView",setup(T){const c=new Oe(ve()),d=Ue(),I=u([]),M=u([]),R=u(!1),k=u(!1),q=u(null),S=u(""),D=u(new Set),Y=u(),O=u(!1),i=u({name:"",path:"",icon:"",parent_id:null,sort_order:999}),m=u(!1),n=u(null),h=u(new Map),w=u(!1),P=u([]),X=u(!1),H=u([]),$=u([]),L=u(""),A=u(null),U=u(""),V=u(""),F=u(new Map),re=["ADMIN","MANAGER","OPERATOR","DRIVER","VIEWER"],ye=["GET","POST","PUT","DELETE","PATCH"],Ie=ie(()=>{const s=new Set;return H.value.forEach(t=>{t.tags.forEach(p=>s.add(p))}),Array.from(s).sort()}),pe=ie(()=>{const s=I.value.filter(g=>{var a;if(S.value){const v=S.value.toLowerCase();if(!g.name.toLowerCase().includes(v)&&!((a=g.path)!=null&&a.toLowerCase().includes(v)))return!1}return!0}),t=s.filter(g=>!g.parent_id),p=g=>s.filter(a=>a.parent_id===g).map(a=>({...a,children:p(a.id)})).sort((a,v)=>(a.sort_order||999)-(v.sort_order||999));return t.map(g=>({...g,children:p(g.id)})).sort((g,a)=>(g.sort_order||999)-(a.sort_order||999))}),Ee=ie(()=>I.value.filter(s=>{let t=0,p=s;for(;p.parent_id&&t<2;)p=I.value.find(g=>g.id===p.parent_id)||p,t++;return t<2}).map(s=>{const t=s.parent_id?I.value.find(p=>p.id===s.parent_id):null;return{...s,parent_name:t==null?void 0:t.name}})),x=async()=>{try{R.value=!0,q.value=null;const s=await c.getMenusApiMenusGet();if(s.data){const t=Array.isArray(s.data)?s.data:s.data.items||[];I.value=t,t.filter(p=>!p.parent_id).forEach(p=>D.value.add(p.id))}await _e()}catch(s){console.error("Failed to load menus:",s),q.value=s.message}finally{R.value=!1}},_e=async()=>{try{const s=[];for(const t of re)try{const p=await c.getRoleMenuPermissionsApiMenusPermissionsRoleGet(t);if(p.data&&p.data.menus){const g=p.data.menus.filter(a=>a.id!==void 0).map(a=>({role:p.data.role,menu_id:a.id,can_read:a.can_read??!1,can_create:a.can_create??!1,can_update:a.can_update??!1,can_delete:a.can_delete??!1}));s.push(...g)}}catch{}s.length>0&&(M.value=s)}catch(s){console.error("Failed to load permissions:",s)}},B=s=>{s?i.value={id:s.id,name:s.name,path:s.path,icon:s.icon,parent_id:s.parent_id,sort_order:s.sort_order}:i.value={name:"",path:"",icon:"",parent_id:null,sort_order:999},O.value=!0},de=s=>{i.value={name:"",path:s.path+"/",icon:"",parent_id:s.id,sort_order:999},O.value=!0},Q=()=>{O.value=!1,i.value={}},Te=async()=>{try{k.value=!0,i.value.id?await c.updateMenuApiMenusMenuIdPut(i.value.id,i.value):await c.createMenuApiMenusPost(i.value),Q(),await x()}catch(s){console.error("Failed to save menu:",s),alert("메뉴 저장 실패: "+s.message)}finally{k.value=!1}},Z=async s=>{if(confirm(`"${s.name}" 메뉴를 삭제하시겠습니까?`))try{await c.deleteMenuApiMenusMenuIdDelete(s.id),await x()}catch(t){console.error("Failed to delete menu:",t),alert("메뉴 삭제 실패: "+t.message)}},le=s=>{D.value.has(s)?D.value.delete(s):D.value.add(s)},ee=s=>{n.value=s,h.value.clear(),M.value.filter(t=>t.menu_id===s.id&&t.role).forEach(t=>{t.role&&h.value.set(t.role,{can_read:t.can_read||!1,can_create:t.can_create||!1,can_update:t.can_update||!1,can_delete:t.can_delete||!1})}),m.value=!0},K=()=>{m.value=!1,n.value=null,h.value.clear()},j=(s,t)=>{const p=h.value.get(s);return p?p[t]:!1},J=(s,t)=>{const p=h.value.get(s)||{can_read:!1,can_create:!1,can_update:!1,can_delete:!1};p[t]=!p[t],h.value.set(s,{...p})},ce=s=>{const t=h.value.get(s);return t?t.can_read&&t.can_create&&t.can_update&&t.can_delete:!1},ke=s=>{const t=ce(s);h.value.set(s,{can_read:!t,can_create:!t,can_update:!t,can_delete:!t})},De=async()=>{var s;if(n.value)try{k.value=!0;for(const[t,p]of h.value.entries()){const g=p.can_read||p.can_create||p.can_update||p.can_delete;try{let v=(await c.getRoleMenuPermissionsApiMenusPermissionsRoleGet(t)).data.menu_ids||[];g?v.includes(n.value.id)||v.push(n.value.id):v=v.filter(l=>l!==n.value.id),v.length>0?await c.updateRoleMenuPermissionsApiMenusPermissionsRolePut(t,{role:t,menu_ids:v}):await c.deleteRoleMenuPermissionsApiMenusPermissionsRoleDelete(t)}catch(a){if(((s=a.response)==null?void 0:s.status)===404)g&&await c.setRoleMenuPermissionsApiMenusPermissionsPost({role:t,menu_ids:[n.value.id]});else throw a}}await _e(),K()}catch(t){console.error("Failed to save permissions:",t),alert("권한 저장 실패: "+t.message)}finally{k.value=!1}},Ae=s=>({ADMIN:"관리자",MANAGER:"매니저",OPERATOR:"운영자",DRIVER:"운전자",VIEWER:"조회자"})[s]||s,fe=()=>{clearTimeout(Y.value),Y.value=setTimeout(()=>{},300)},te=async s=>{n.value=s,w.value=!0,await d.loadMenuApiEndpoints(s.id),P.value=d.endpoints,H.value=Ve(),L.value="",U.value="",V.value="",A.value=null,z()},ae=()=>{w.value=!1,n.value=null,P.value=[],H.value=[],$.value=[]},z=()=>{let s=H.value;L.value&&(s=Fe(L.value)),U.value&&(s=s.filter(t=>t.method===U.value)),V.value&&(s=s.filter(t=>t.tags.includes(V.value))),$.value=s},be=s=>{A.value=s},Ge=async()=>{if(!(!n.value||!A.value))try{X.value=!0,await d.createMenuApiEndpoint(n.value.id,{menu_id:n.value.id,method:A.value.method,path:A.value.path,description:A.value.summary||void 0}),await d.loadMenuApiEndpoints(n.value.id),P.value=d.endpoints,F.value.set(n.value.id,d.endpoints.length),A.value=null}catch(s){console.error("Failed to add API endpoint:",s),alert("API 엔드포인트 추가 실패: "+s.message)}finally{X.value=!1}},Me=async s=>{if(n.value&&confirm("이 API 엔드포인트를 삭제하시겠습니까?"))try{await d.deleteMenuApiEndpoint(n.value.id,s),await d.loadMenuApiEndpoints(n.value.id),P.value=d.endpoints,F.value.set(n.value.id,d.endpoints.length)}catch(t){console.error("Failed to delete API endpoint:",t),alert("API 엔드포인트 삭제 실패: "+t.message)}},ue=s=>d.getMethodColor(s),C=s=>F.value.get(s)||0,Pe=async()=>{try{for(const s of I.value)try{await d.loadMenuApiEndpoints(s.id),F.value.set(s.id,d.endpoints.length)}catch{F.value.set(s.id,0)}}catch(s){console.error("Failed to load menu API counts:",s)}};return Ne(async()=>{await x(),await Pe()}),(s,t)=>{var p,g;return r(),o("div",We,[t[29]||(t[29]=e("div",{class:"page-header"},[e("h1",null,"메뉴 관리"),e("p",{class:"subtitle"},"시스템 메뉴와 권한을 관리합니다.")],-1)),e("div",He,[e("div",$e,[t[10]||(t[10]=e("label",null,"검색",-1)),f(e("input",{"onUpdate:modelValue":t[0]||(t[0]=a=>S.value=a),type:"text",class:"form-control",placeholder:"메뉴명, 경로 검색",onInput:fe},null,544),[[N,S.value]])]),e("button",{onClick:t[1]||(t[1]=a=>B()),class:"btn btn-primary"},t[11]||(t[11]=[e("span",{class:"icon"},"+",-1),he(" 새 메뉴 ",-1)])),e("button",{onClick:x,class:"btn btn-secondary"},t[12]||(t[12]=[e("span",{class:"icon"},"🔄",-1),he(" 새로고침 ",-1)]))]),R.value?(r(),o("div",Ot,t[14]||(t[14]=[e("div",{class:"spinner"},null,-1),e("p",null,"메뉴를 불러오는 중...",-1)]))):(r(),o("div",xe,[e("div",Be,[(r(!0),o(b,null,G(pe.value,a=>{var v;return r(),o("div",{key:a.id,class:"tree-node"},[e("div",Qe,[e("div",Ke,[a.children&&a.children.length?(r(),o("span",{key:0,class:"expand-icon",onClick:l=>le(a.id)},_(D.value.has(a.id)?"▼":"▶"),9,je)):(r(),o("span",Je,"▶")),e("span",ze,_(a.icon||"📄"),1),e("span",qe,_(a.name),1),e("span",Ye,_(a.path),1),e("span",Xe,"["+_(a.sort_order)+"]",1),C(a.id)>0?(r(),o("span",Ze," API: "+_(C(a.id)),1)):E("",!0)]),e("div",et,[e("button",{onClick:l=>te(a),class:"btn-icon",title:"API 엔드포인트"}," 📡 ",8,tt),e("button",{onClick:l=>ee(a),class:"btn-icon",title:"권한 설정"}," 🔐 ",8,at),e("button",{onClick:l=>B(a),class:"btn-icon",title:"수정"},"✏️",8,st),e("button",{onClick:l=>de(a),class:"btn-icon",title:"하위 메뉴 추가"}," ➕ ",8,it),(v=a.children)!=null&&v.length?E("",!0):(r(),o("button",{key:0,onClick:l=>Z(a),class:"btn-icon",title:"삭제"}," 🗑️ ",8,nt))])]),a.children&&a.children.length&&D.value.has(a.id)?(r(),o("div",ot,[(r(!0),o(b,null,G(a.children,l=>{var me;return r(),o("div",{key:l.id,class:"tree-node child-node"},[e("div",rt,[e("div",pt,[l.children&&l.children.length?(r(),o("span",{key:0,class:"expand-icon",onClick:y=>le(l.id)},_(D.value.has(l.id)?"▼":"▶"),9,_t)):(r(),o("span",dt,"▶")),e("span",lt,_(l.icon||"📄"),1),e("span",ct,_(l.name),1),e("span",ut,_(l.path),1),e("span",mt,"["+_(l.sort_order)+"]",1),C(l.id)>0?(r(),o("span",ht," API: "+_(C(l.id)),1)):E("",!0)]),e("div",gt,[e("button",{onClick:y=>te(l),class:"btn-icon",title:"API 엔드포인트"}," 📡 ",8,vt),e("button",{onClick:y=>ee(l),class:"btn-icon",title:"권한 설정"}," 🔐 ",8,yt),e("button",{onClick:y=>B(l),class:"btn-icon",title:"수정"},"✏️",8,It),e("button",{onClick:y=>de(l),class:"btn-icon",title:"하위 메뉴 추가"}," ➕ ",8,Et),(me=l.children)!=null&&me.length?E("",!0):(r(),o("button",{key:0,onClick:y=>Z(l),class:"btn-icon",title:"삭제"}," 🗑️ ",8,Tt))])]),l.children&&l.children.length&&D.value.has(l.id)?(r(),o("div",kt,[(r(!0),o(b,null,G(l.children,y=>(r(),o("div",{key:y.id,class:"tree-node grandchild-node"},[e("div",Dt,[e("div",At,[t[13]||(t[13]=e("span",{class:"expand-icon",style:{visibility:"hidden"}},"▶",-1)),e("span",ft,_(y.icon||"📄"),1),e("span",bt,_(y.name),1),e("span",Gt,_(y.path),1),e("span",Mt,"["+_(y.sort_order)+"]",1),C(y.id)>0?(r(),o("span",Pt," API: "+_(C(y.id)),1)):E("",!0)]),e("div",wt,[e("button",{onClick:se=>te(y),class:"btn-icon",title:"API 엔드포인트"}," 📡 ",8,Ct),e("button",{onClick:se=>ee(y),class:"btn-icon",title:"권한 설정"}," 🔐 ",8,Nt),e("button",{onClick:se=>B(y),class:"btn-icon",title:"수정"}," ✏️ ",8,Rt),e("button",{onClick:se=>Z(y),class:"btn-icon",title:"삭제"}," 🗑️ ",8,St)])])]))),128))])):E("",!0)])}),128))])):E("",!0)])}),128))])])),!R.value&&pe.value.length===0?(r(),o("div",Lt,t[15]||(t[15]=[e("p",null,"메뉴가 없습니다.",-1)]))):E("",!0),O.value?(r(),o("div",{key:3,class:"modal-overlay",onClick:W(Q,["self"])},[e("div",Ut,[e("div",Vt,[e("h2",null,_(i.value.id?"메뉴 수정":"새 메뉴 추가"),1),e("button",{onClick:Q,class:"close-btn"},"×")]),e("div",Ft,[e("form",{onSubmit:W(Te,["prevent"])},[e("div",Wt,[t[16]||(t[16]=e("label",null,"메뉴명 *",-1)),f(e("input",{"onUpdate:modelValue":t[2]||(t[2]=a=>i.value.name=a),type:"text",class:"form-control",required:"",placeholder:"예: 대시보드"},null,512),[[N,i.value.name]])]),e("div",Ht,[t[17]||(t[17]=e("label",null,"경로 *",-1)),f(e("input",{"onUpdate:modelValue":t[3]||(t[3]=a=>i.value.path=a),type:"text",class:"form-control",required:"",placeholder:"예: /dashboard"},null,512),[[N,i.value.path]])]),e("div",$t,[t[18]||(t[18]=e("label",null,"아이콘",-1)),f(e("input",{"onUpdate:modelValue":t[4]||(t[4]=a=>i.value.icon=a),type:"text",class:"form-control",placeholder:"예: 📊"},null,512),[[N,i.value.icon]])]),e("div",xt,[t[20]||(t[20]=e("label",null,"부모 메뉴",-1)),f(e("select",{"onUpdate:modelValue":t[5]||(t[5]=a=>i.value.parent_id=a),class:"form-control"},[t[19]||(t[19]=e("option",{value:null},"없음 (최상위 메뉴)",-1)),(r(!0),o(b,null,G(Ee.value,a=>(r(),o("option",{key:a.id,value:a.id},_(a.name)+" "+_(a.parent_name?`(${a.parent_name})`:""),9,Bt))),128))],512),[[ne,i.value.parent_id]])]),e("div",Qt,[t[21]||(t[21]=e("label",null,"정렬 순서",-1)),f(e("input",{"onUpdate:modelValue":t[6]||(t[6]=a=>i.value.sort_order=a),type:"number",class:"form-control",placeholder:"999"},null,512),[[N,i.value.sort_order,void 0,{number:!0}]])]),e("div",Kt,[e("button",{type:"submit",class:"btn btn-primary",disabled:k.value},_(k.value?"저장 중...":"저장"),9,jt),e("button",{type:"button",onClick:Q,class:"btn btn-secondary"},"취소")])],32)])])])):E("",!0),m.value?(r(),o("div",{key:4,class:"modal-overlay",onClick:W(K,["self"])},[e("div",Jt,[e("div",zt,[e("h2",null,"권한 설정: "+_((p=n.value)==null?void 0:p.name),1),e("button",{onClick:K,class:"close-btn"},"×")]),e("div",qt,[e("div",Yt,[e("table",Xt,[t[22]||(t[22]=e("thead",null,[e("tr",null,[e("th",null,"역할"),e("th",null,"조회 (GET)"),e("th",null,"생성 (POST)"),e("th",null,"수정 (PUT/PATCH)"),e("th",null,"삭제 (DELETE)"),e("th",null,"전체")])],-1)),e("tbody",null,[(r(),o(b,null,G(re,a=>e("tr",{key:a},[e("td",Zt,_(Ae(a)),1),e("td",ea,[e("input",{type:"checkbox",checked:j(a,"can_read"),onChange:v=>J(a,"can_read")},null,40,ta)]),e("td",aa,[e("input",{type:"checkbox",checked:j(a,"can_create"),onChange:v=>J(a,"can_create")},null,40,sa)]),e("td",ia,[e("input",{type:"checkbox",checked:j(a,"can_update"),onChange:v=>J(a,"can_update")},null,40,na)]),e("td",oa,[e("input",{type:"checkbox",checked:j(a,"can_delete"),onChange:v=>J(a,"can_delete")},null,40,ra)]),e("td",pa,[e("input",{type:"checkbox",checked:ce(a),onChange:v=>ke(a)},null,40,_a)])])),64))])])]),e("div",da,[e("button",{onClick:De,class:"btn btn-primary",disabled:k.value},_(k.value?"저장 중...":"권한 저장"),9,la),e("button",{onClick:K,class:"btn btn-secondary"},"닫기")])])])])):E("",!0),w.value?(r(),o("div",{key:5,class:"modal-overlay",onClick:W(ae,["self"])},[e("div",ca,[e("div",ua,[e("h2",null,"API 엔드포인트: "+_((g=n.value)==null?void 0:g.name),1),e("button",{onClick:ae,class:"close-btn"},"×")]),e("div",ma,[e("div",ha,[t[28]||(t[28]=e("h3",null,"새 엔드포인트 추가",-1)),e("div",ga,[e("div",va,[t[23]||(t[23]=e("label",null,"검색",-1)),f(e("input",{"onUpdate:modelValue":t[7]||(t[7]=a=>L.value=a),type:"text",class:"form-control",placeholder:"경로, 설명, 태그 검색...",onInput:z},null,544),[[N,L.value]])]),e("div",ya,[t[25]||(t[25]=e("label",null,"메소드",-1)),f(e("select",{"onUpdate:modelValue":t[8]||(t[8]=a=>U.value=a),class:"form-control",onChange:z},[t[24]||(t[24]=e("option",{value:""},"전체",-1)),(r(),o(b,null,G(ye,a=>e("option",{key:a,value:a},_(a),9,Ia)),64))],544),[[ne,U.value]])]),e("div",Ea,[t[27]||(t[27]=e("label",null,"태그",-1)),f(e("select",{"onUpdate:modelValue":t[9]||(t[9]=a=>V.value=a),class:"form-control",onChange:z},[t[26]||(t[26]=e("option",{value:""},"전체",-1)),(r(!0),o(b,null,G(Ie.value,a=>(r(),o("option",{key:a,value:a},_(a),9,Ta))),128))],544),[[ne,V.value]])])]),e("div",ka,[e("div",Da," 사용 가능한 엔드포인트: "+_($.value.length)+"개 ",1),e("div",Aa,[(r(!0),o(b,null,G($.value,a=>(r(),o("div",{key:`${a.method}-${a.path}`,class:Re(["available-endpoint-item",{selected:A.value===a}]),onClick:v=>be(a)},[e("span",{class:"method-badge",style:ge({background:ue(a.method)})},_(a.method),5),e("div",ba,[e("div",Ga,_(a.path),1),e("div",Ma,_(a.summary),1)]),A.value===a?(r(),o("button",{key:0,type:"button",onClick:W(Ge,["stop"]),class:"btn btn-sm btn-primary",disabled:X.value}," 추가 ",8,Pa)):E("",!0)],10,fa))),128))])])]),e("div",wa,[e("h3",null,"등록된 엔드포인트 ("+_(P.value.length)+"개)",1),P.value.length===0?(r(),o("div",Ca," 등록된 API 엔드포인트가 없습니다. ")):(r(),o("div",Na,[(r(!0),o(b,null,G(P.value,a=>(r(),o("div",{key:a.id,class:"endpoint-item"},[e("div",Ra,[e("span",{class:"method-badge",style:ge({background:ue(a.method)})},_(a.method),5),e("span",Sa,_(a.path),1),e("span",Oa,_(a.description),1)]),e("button",{onClick:v=>Me(a.id),class:"btn-icon",title:"삭제"}," 🗑️ ",8,La)]))),128))]))]),e("div",{class:"form-actions"},[e("button",{onClick:ae,class:"btn btn-secondary"},"닫기")])])])])):E("",!0)])}}}),$a=Se(Ua,[["__scopeId","data-v-be351f5b"]]);export{$a as default};
